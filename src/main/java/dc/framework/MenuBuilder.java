...
public class MenuBuilder implements Serializable {
	...
	private HashMap<Integer, HashMap<MenuItem, List<MenuItem>>> buildFirstPass(MenuBar bar, HorizontalLayout menuPanel,
			List<FmMenu> menusDoModulo) {
	...
	private void addChild(HashMap<Integer,HashMap<MenuItem,List<MenuItem>>> estruturaMenus,	FmMenu m, MainController mainController, Usuario u,String moduleID) {
	...
	private void showControllerSistema(
			final MainController mainController, dc.visao.framework.geral.Controller c) {
