...
public class ModelInterceptor extends EmptyInterceptor {
	...
	private void setMultiEmpresa(Object entity, Object[] state, String[] properties) {
		...
		if (entity instanceof AbstractMultiEmpresaModel) {
			...
			if (SecuritySessionProvider.getUsuario() != null) {
				setValue(state, properties, propertyName, SecuritySessionProvider.getUsuario().getConta().getEmpresa());
			}
