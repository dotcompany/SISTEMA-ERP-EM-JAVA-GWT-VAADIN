...
@Component
@Scope("prototype")
public class EntradaServicoListController extends CRUDListController<Cor> {
	...
	@Autowired
	EntradaServicoFormController formController;
	...
	@Override
	protected Class<? super Cor> getEntityClass() {
		return Cor.class;
	}
