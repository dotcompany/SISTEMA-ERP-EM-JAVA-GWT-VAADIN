...
import dc.visao.ordemservico.EntradaServicoFormView;
...
@Controller
@Scope("prototype")
public class EntradaServicoFormController extends CRUDFormController<Cor> {

	private static final long serialVersionUID = 1L;

	EntradaServicoFormView subView;
	...
	protected void initSubView() {
		subView = new EntradaServicoFormView();
	}
