...
public class FreteFormController extends CRUDFormController<Frete> {
	...
	protected void carregar(Serializable id) {
		...
		try{
			...
			if(conhecimento!=null)subView.getTxtConhecimento().setValue(conhecimento.toString());
			if(responsavel!=null)subView.getTxtResponsavel().setValue(currentBean.getResponsavel().toString());
			if(placa!=null)subView.getTxtPlaca().setValue(currentBean.getPlaca().toString());
			if(ufPlaca!=null)subView.getTxtUfPlaca().setValue(currentBean.getUfPlaca().toString());

			if(seloFiscal!=null)subView.getTxtSeloFiscal().setValue(currentBean.getSeloFiscal().toString());
			if(quantidadeVolume!=null)subView.getTxtQuantidadeVolumes().setValue(currentBean.getQuantidadeVolume().toString());
			...
			if(pesoBruto!=null)subView.getTxtPesoBruto().setValue(currentBean.getPesoBruto().toString());
			if(pesoLiquido!=null)subView.getTxtPesoLiquido().setValue(currentBean.getPesoLiquido().toString());
