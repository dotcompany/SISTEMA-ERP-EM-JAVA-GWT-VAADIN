...
import dc.visao.tabelas.EfdTabela4314FormView;

/** @author Wesley Jr /* */

@Controller
@Scope("prototype")
public class EfdTabela4314FormController extends CRUDFormController<EfdTabela4314> {

	EfdTabela4314FormView subView;

	@Autowired
	EfdTabela4314DAO efdTabela4314DAO;

	private EfdTabela4314 currentBean;
	...
	@Override
	public EfdTabela4314 getModelBean() {
		return currentBean;
	}
