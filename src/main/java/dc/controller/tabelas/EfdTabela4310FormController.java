...
import dc.visao.tabelas.EfdTabela4310FormView;

/** @author Wesley Jr /* */

@Controller
@Scope("prototype")
public class EfdTabela4310FormController extends CRUDFormController<EfdTabela4310> {

	EfdTabela4310FormView subView;

	@Autowired
	EfdTabela4310DAO efdTabela4310DAO;

	private EfdTabela4310 currentBean;
	...
	@Override
	public EfdTabela4310 getModelBean() {
