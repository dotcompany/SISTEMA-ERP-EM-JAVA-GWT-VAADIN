...
import dc.entidade.tabelas.SalarioMinimo;
import dc.framework.exception.ErroValidacaoException;
import dc.servicos.dao.tabelas.SalarioMinimoDAO;
...
public class SalarioMinimoFormController extends CRUDFormController<SalarioMinimo> {
	...
	protected void carregar(Serializable id) {
		...
		subView.getTxtValorHora().setValue(currentBean.getValorHora().toString());
