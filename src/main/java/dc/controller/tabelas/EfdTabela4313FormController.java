...
import dc.visao.tabelas.EfdTabela4313FormView;

/** @author Wesley Jr /* */

@Controller
@Scope("prototype")
public class EfdTabela4313FormController extends CRUDFormController<EfdTabela4313> {

	EfdTabela4313FormView subView;

	@Autowired
	EfdTabela4313DAO efdTabela4313DAO;

	private EfdTabela4313 currentBean;
	...
	@Override
	public EfdTabela4313 getModelBean() {
		return currentBean;
	}
