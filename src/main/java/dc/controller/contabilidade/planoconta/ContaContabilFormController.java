...
@Controller
@Scope("prototype")
public class ContaContabilFormController extends
		CRUDFormController<ContaContabilEntity> {
	...
	private ContaContabilFormView subView;
	...
	private ContaContabilEntity pEntity;

	/**
	 * CONSTRUTOR
	 */

	public ContaContabilFormController() {
		if (this.pEntity == null) {
			this.pEntity = new ContaContabilEntity();
		}
	}
