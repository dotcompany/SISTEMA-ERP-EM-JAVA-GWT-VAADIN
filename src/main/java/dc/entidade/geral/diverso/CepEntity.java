...
public class CepEntity extends AbstractMultiEmpresaModel<Integer> implements Serializable {
	 ...
	 * @Basic(optional = false)
	 * 
	 * @Column(name = "CIDADE_ID", nullable = false) private int cidadeId;
	 */
	@Field
	@Caption("Cep")
	...
	public boolean equals(Object object) {
		if (object instanceof CepEntity == false)
			return false;

		if (this == object)
			return true;

		final CepEntity other = (CepEntity) object;
