...
public class OrcamentoOsItem extends AbstractMultiEmpresaModel<Integer> {
	...
	private OrcamentoOs orcamentoOs; 
	...
	public OrcamentoOs getOrcamentoOs() {
		return orcamentoOs;
	}

	public void setOrcamentoOs(OrcamentoOs orcamentoOs) {
