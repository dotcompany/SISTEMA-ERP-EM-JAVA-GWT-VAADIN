...
public class Municipio extends AbstractMultiEmpresaModel<Integer> implements Serializable {
	...
	public Empresa getIdUf() {
		return idUf;
	}

	public void setIdUf(Empresa idUf) {
		this.idUf = idUf;
	}
	...
	public boolean equals(Object object) {
		if (object instanceof Municipio == false)
			return false;

		if (this == object)
			return true;

		final Municipio other = (Municipio) object;
