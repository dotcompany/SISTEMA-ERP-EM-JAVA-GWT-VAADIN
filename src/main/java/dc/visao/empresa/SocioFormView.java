...
public class SocioFormView extends CustomComponent {
	...
	private SubFormComponent<Dependente, Integer> buildDependentesSubForm() {
		...
		dependentesSubForm = new SubFormComponent<Dependente, Integer>(Dependente.class, new String[] { 
	...
	private SubFormComponent<ParticipacaoSocietaria, Integer> buildParticipacoesSubForm() {
		...
		participacoesSubForm = new SubFormComponent<ParticipacaoSocietaria, Integer>(ParticipacaoSocietaria.class, new String[] { 
				...
				return new TableFieldFactory() {
					...
					public Field<?> createField(Container container, Object itemId, Object propertyId, Component uiContext) {
						...
						if ("cnpj".equals(propertyId)) {
							TextField textField = ComponentUtil.buildTextField("CNPJ");
							return textField;
						}
			...
			protected ParticipacaoSocietaria getNovo() {
				ParticipacaoSocietaria detalhe = controller.adicionarParticipacao();
				return detalhe;
			}
