...
public class SocioFormView extends CustomComponent {
	...
	private SubFormComponent<ParticipacaoSocietaria, Integer> buildParticipacoesSubForm() {
		...
		participacoesSubForm = new SubFormComponent<ParticipacaoSocietaria, Integer>(
				ParticipacaoSocietaria.class, new String[] { "cnpj","razaoSocial","dataEntrada" ,"dataSaida","participacao","dirigente" },
			...
			protected TableFieldFactory getFieldFactory() {
				return new TableFieldFactory() {
					...
					public Field<?> createField(Container container,
						...
						if ("dirigente".equals(propertyId)) {
...
public enum DIRIGENTE{
		...
		public static DIRIGENTE getPrincipal(String codigo) {
			if (codigo.equals("0")) {
				return NAO;
			}
			if (codigo.equals("1")) {
