...
public class ClienteFormView extends CustomComponent {
	...
	public void preencheCliente(Cliente cliente) {
		...
		cliente.setPessoa((Pessoa) cmbPessoa.getValue());
		...
		/*GerarFinanceiroType enumGeraFinanceiro = (GerarFinanceiroType) (cmbGerarFinanceiro.getValue());
		...
		FormaDescontoType enumFormaDesconto = (FormaDescontoType) (cmbFormaDesconto.getValue());
		...
		TipoFreteType enumTipoFrete = (TipoFreteType) (cmbTipoFrete.getValue());
		if (Validator.validateObject(enumTipoFrete)) {
			String tipoFrete = (enumTipoFrete).getCodigo();
			cliente.setTipoFrete(tipoFrete);
		}*/
		
		cliente.setPorcentoDesconto((BigDecimal) txtTaxaDesconto.getConvertedValue());
		cliente.setLimiteCredito((BigDecimal) txtLimiteCredito.getConvertedValue());

	}
	
	public void preencheClienteForm(Cliente cliente) {
