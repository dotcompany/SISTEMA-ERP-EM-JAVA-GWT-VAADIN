...
public class ClienteFormView extends CustomComponent {
	...
	public void preencheCliente(ClienteEntity cliente) {
		cliente.setPessoa((PessoaEntity) mocPessoa.getValue());
		cliente.setContabilConta((ContabilContaEntity) mocContaContabil
				.getValue());
		cliente.setSituacaoForCli((SituacaoForCliEntity) mocSituacao.getValue());
		cliente.setAtividadeForCli((AtividadeForCliEntity) mocAtividade
				.getValue());
		cliente.setOperacaoFiscal((OperacaoFiscalEntity) mocOperacaoFiscal
				.getValue());
	...
	public void preencheClienteForm(ClienteEntity cliente) {
		mocPessoa.setValue(cliente.getPessoa());
		mocContaContabil.setValue(cliente.getContabilConta());
		mocSituacao.setValue(cliente.getSituacaoForCli());
		mocAtividade.setValue(cliente.getAtividadeForCli());
		mocOperacaoFiscal.setValue(cliente.getOperacaoFiscal());
