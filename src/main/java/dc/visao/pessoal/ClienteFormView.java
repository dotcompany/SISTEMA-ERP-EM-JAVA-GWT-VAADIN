...
public class ClienteFormView extends CustomComponent {
	...
	public void InitCbs(/*
						 * List<Pessoa> pessoa, List<SituacaoForCli>
						 * situacaoForCli, List<ContabilConta> contaContabil,
						 * List<AtividadeForCli> atividadeForCli,
						 * List<OperacaoFiscal> operacaoFiscal
						 */) {
		 ...
		 * 
		 * BeanItemContainer<SituacaoForCli> objectssituacao = new
		 * BeanItemContainer<SituacaoForCli>(SituacaoForCli.class,
		 * situacaoForCli); cmbSituacao.setContainerDataSource(objectssituacao);
		 * 
		 * BeanItemContainer<ContabilConta> objectscontabil= new
		 * BeanItemContainer<ContabilConta>(ContabilConta.class, contaContabil);
		 * cmbContaContabil.setContainerDataSource(objectscontabil);
		 * 
		 * BeanItemContainer<AtividadeForCli> objectsatividade= new
		 * BeanItemContainer<AtividadeForCli>(AtividadeForCli.class,
		 * atividadeForCli);
		 * cmbContaContabil.setContainerDataSource(objectsatividade);
		 * 
		 * BeanItemContainer<OperacaoFiscal> objectsoperacao = new
		 * BeanItemContainer<OperacaoFiscal>(OperacaoFiscal.class,
		 * operacaoFiscal);
