...
public class ColaboradorFormView extends CustomComponent {
	...
	@AutoGenerated
	private TextField txtCategoria, txtSalarioFixo,txtComissaoProduto,txtComissaoServico;
	@AutoGenerated
	...
	@AutoGenerated
	private ComboBox cbPriorizarPgto,cbComissaoOver,cbPgtoComissao,cbLctoComissao;
...
//		gridLayout_1.setHeight("100.0%");
		...
		txtComissaoServico = ComponentUtil.buildCurrencyField("Valor comissão serviço");
		...
		txtComissaoProduto = ComponentUtil.buildCurrencyField("Valor comissão produto");
