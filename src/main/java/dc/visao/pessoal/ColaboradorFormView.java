...
public class ColaboradorFormView extends CustomComponent {
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		// cmbTipoColaborador
		cmbTipoColaborador = new ManyToOneCombo<TipoColaborador>();
		...
		cmbSituacaoColaborador = new ManyToOneCombo<SituacaoColaborador>();
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		// cmbNivelFormacao
		cmbNivelFormacao = new ManyToOneCombo<NivelFormacao>();
		...
		// cmbCargo
		cmbCargo = new ManyToOneCombo<Cargo>();
		...
		// cmbContaContabil
		cmbContaContabil = new ManyToOneCombo<ContabilConta>();
		...
		// cmbSetor
		cmbSetor = new ManyToOneCombo<Setor>();
