...
public class SituacaoColaboradorFormView extends CustomComponent {
	...
	public VerticalLayout getHorizontalLayout_2() {
		return mainLayout;
	}

	public void setHorizontalLayout_2(VerticalLayout mainLayout) {
