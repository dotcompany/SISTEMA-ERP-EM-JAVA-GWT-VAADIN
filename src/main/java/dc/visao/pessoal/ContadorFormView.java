...
public class ContadorFormView extends CustomComponent {
	...
	public void InitCbs(List<Pessoa> pessoa, List<UF> uf) {
		 ...
		 BeanItemContainer<Pessoa> objectspessoa = new BeanItemContainer<Pessoa>(Pessoa.class, pessoa);
		 cmbPessoa.setContainerDataSource(objectspessoa);
		 
		 BeanItemContainer<UF> objectsuf = new BeanItemContainer<UF>(UF.class, uf);
