...
public class ContratosFormView extends CustomComponent {
	...
	SubFormComponent<ContratoProduto, Integer> subForm = new SubFormComponent<ContratoProduto, Integer>(
			ContratoProduto.class, new String[] { "produto" },
			new String[] { "Produto" }) {
	...
	private SubFormComponent<ContratoProduto, Integer> buildObjetoProdutoSubForm() {
		//private Component buildSubFormNaturezaFinanceira() {
			...
			this.contratoProdutoSubForm = new SubFormComponent<ContratoProduto, Integer>(
					ContratoProduto.class, atributos, headers) {
				...
				protected TableFieldFactory getFieldFactory() {
					return new TableFieldFactory() {
						...
						if ("produto".equals(propertyId)) {
							...
							produtoText
									.setConverter(new Converter<String, ProdutoEntity>() {
								 ...
								 * 
										...
										@Override
										public ProdutoEntity convertToModel(
												String value,
												Class<? extends ProdutoEntity> targetType,
												Locale locale)
										...
										@Override
										public Class<ProdutoEntity> getModelType() {
	...
	public void preencheContrato(ContratoEntity contrato) {
		...
		contrato.setDocumento((Documento) cbmDocumento.getValue());
	...
	public void preencheContratoForm(ContratoEntity contrato) {
		...
		cbmDocumento.setValue(contrato.getDocumento());
		cmbSolicitacaoServico
