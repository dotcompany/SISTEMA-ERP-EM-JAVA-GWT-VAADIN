...
public class VendaFormView extends CustomComponent {
	...
	ComboBox cmbTipoVenda, cmbOrcamento, cmbTipoNotaFiscal, cmbVendedor,
			cmbCliente, cmbTransportadora, cmbCondicoesPagamento,
			cmbFormaPagamento, cmbFrete;
	...
	private GridLayout buildFields() {
		...
		cmbTipoNotaFiscal.setContainerDataSource(controller
				.carregarTipoNotaFiscal());
		...
		cmbCondicoesPagamento.setContainerDataSource(controller
