...
public class OrcamentoFormView extends CustomComponent {
	...
	private TabSheet buildItensSubForm() {
		...
		itensSubForm = new SubFormComponent<ItemOrcamento, Integer>(ItemOrcamento.class, 
				new String[] {	"produto","quantidade","valorUnitario","valorSubTotal","taxaDesconto","valorDesconto","valorTotal"}, 
