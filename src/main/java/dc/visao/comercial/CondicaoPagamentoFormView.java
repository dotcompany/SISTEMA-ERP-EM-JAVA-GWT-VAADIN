...
public class CondicaoPagamentoFormView extends CustomComponent {
	...
	private void buildParcelasSubForm() {
		...
		parcelasSubForm = new SubFormComponent<ParcelaCondicaoPagamento, Integer>(ParcelaCondicaoPagamento.class, new String[] { 
			"parcela","dias","taxa"}, new String[] {"Parcela","Dias","Taxa"}) {
