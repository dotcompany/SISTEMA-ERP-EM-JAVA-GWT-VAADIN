...
/*public void montaAbaDependentes() {
	...
	layout.setSizeFull();
	layout.addComponent(buildSubFormDetalhe());
	subForms.addTab(layout, "Detalhes", null);
}
...
private SubFormComponent<IcmsCustomizadoDetalheEntity, Integer> buildSubFormDetalhe() {
	...
	sub.addTab(detalheSubForm, "", null);*/

public void montaAbaDependentes() {
	TabSheet abaDependentes = buildSubFormDetalhe();
	GridLayout layout = new GridLayout(1, 1);
	layout.setImmediate(false);
	layout.setWidth("100.0%");
	...
	layout.addComponent(abaDependentes);
...
private TabSheet buildSubFormDetalhe() {
	...
	sub.setImmediate(true);
		...
		String[] campos = new String[] { "ufDestino","cfop", "csosn", "cst", "modalidadeBc", "aliquota","valorPauta", "valorPrecoMaximo" };
					...
					return new TableFieldFactory() {
						...
						public Field<?> createField(Container container,
							...
							if ("cst".equals(propertyId)) {
								...
								combox.setContainerDataSource(controller.carregarCstb());
								return combox;
