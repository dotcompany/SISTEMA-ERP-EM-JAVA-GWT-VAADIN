...
public class OperacaoFiscalFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<CfopEntity> cfop;
	...
	public ManyToOneCombo<CfopEntity> getCfop() {
		return cfop;
	}

	public void setCfop(ManyToOneCombo<CfopEntity> cfop) {
		this.cfop = cfop;
	}
