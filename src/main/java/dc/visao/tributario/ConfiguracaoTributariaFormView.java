...
public class ConfiguracaoTributariaFormView extends CustomComponent {
	...
	public void buildAbaPIS(){
		...
		txtAliquotaUnidadePis = ComponentUtil.buildNumericField("Aliquota Unidade");
	...
	public void buildAbaCofins(){
		...
		txtAliquotaBcCofins = ComponentUtil.buildNumericField("Aliquota Porcento");
		layout.addComponent(txtAliquotaBcCofins,4,2,5,2);

		txtAliquotaUnidadeCofins = ComponentUtil.buildNumericField("Aliquota Unidade");
	...
	public void buildAbaIPI(){
		...
		txtAliquotaUnidadeIPI = ComponentUtil.buildNumericField("Aliquota Unidade");
				...
				return new TableFieldFactory() {
					...
					public Field<?> createField(Container container, Object itemId, Object propertyId, Component uiContext) {
						...
						if ("aliquota".equals(propertyId)) {
							NumericField field = ComponentUtil.buildNumericField("Aliquota");
							return field;
						}
