...
public class FluxoCaixaFormView extends CustomComponent {
	...
	private GridLayout buildFields() {
		...
		fields.addComponent(txNomeFluxo, 0, 1, 1,1);
		
		dtInicial = ComponentUtil.buildPopupDateField("Data Inicial");
		fields.addComponent(dtInicial, 0, 2);
		
		dtInicialBase = ComponentUtil.buildPopupDateField("Data Inicial Base");
		fields.addComponent(dtInicialBase, 1, 2);
		
		txNrPeriodo = ComponentUtil.buildTextField("Nr. Períodos");
		fields.addComponent(txNrPeriodo, 0, 3);
		
		txDescricao = ComponentUtil.buildTextArea("Nr. Períodos");
		fields.addComponent(txDescricao, 0, 4, 2,4);
	...
	private SubFormComponent<FluxoCaixaDetalheEntity, Integer> buildSubFormFluxoCaixaDetalhe() {
		//private Component buildSubFormNaturezaFinanceira() {
			...
			String[] atributos = new String[] { "naturezaFinanceira","tipo", "periodo","valorOrcado","valorRealizado","taxaVariacao","valorVariacao" };
			String[] headers = new String[] { "Natureza Financeira","Tipo", "Período","Valor Orçado","Valor Realizado","taxa Variação","Valor Variação" };
					...
					return new TableFieldFactory() {
						...
						public Field<?> createField(Container container,
							...
							if ("tipo".equals(propertyId)) {
								...
								return f;
							} else if ("valorOrcado".equals(propertyId)) {
