...
public class CopyOfEmpresaFormView extends CustomComponent {
	...
	private GridLayout buildMainLayout() {
		...
		mainLayout.addComponent(absoluteLayout_1, 0, 3);
	...
	private TabSheet buildTabForm() {
		...
		tabForm.addTab(contatoSubForm, "Contato",
				null);

		tabForm.addTab(enderecoSubForm, "Endereço",
				null);
	...
	private SubFormComponent<Contato, Integer> buildContatoSubForm() {
		SubFormComponent<Contato, Integer> subForm = new SubFormComponent<Contato, Integer>(
				Contato.class, new String[] { "nome",
						"email","foneComercial","foneResidencial","foneCelular" }, new String[] { "Nome", "Email","Fone Comercial","Fone Residencial","Celular" }) {
			@Override
	...
	private SubFormComponent<Endereco, Integer> buildEnderecoSubForm() {
		SubFormComponent<Endereco, Integer> subForm = new SubFormComponent<Endereco, Integer>(
				Endereco.class, new String[] { "logradouro","numero", "complemento", "bairro","cidade" ,"cep","municipioIbge","telefone","fone" }, 
				new String[] { "Logradouro","Número", "Complemento", "Bairro","Cidade","Cep","Município Ibge","Telefone","Fone" }) {
			@Override
			protected TableFieldFactory getFieldFactory() {
				return new TableFieldFactory() {
	...
	public void preencheEmpresaForm(Empresa empresa) {
		...
		this.fillEnderecoSubForm(empresa
				.getEnderecos());

		this.fillContatoSubForm(empresa
				.getContato());
