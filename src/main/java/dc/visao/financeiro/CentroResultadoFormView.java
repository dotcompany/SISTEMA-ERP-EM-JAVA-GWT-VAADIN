...
public class CentroResultadoFormView extends CustomComponent {
	 ...
	 * editor.
	 */
	public CentroResultadoFormView() {
		buildMainLayout();
	...
	private GridLayout buildMainLayout() {
		...
		// txtPercentualRateio
		txtPercentualRateio = ComponentUtil.buildPercentageField("Porcentagem do Rateio");
	...
	public void InitCbPlanoCentroResultado(List<PlanoCentroResultado> lista) {
		BeanItemContainer<PlanoCentroResultado> objects = new BeanItemContainer<PlanoCentroResultado>(PlanoCentroResultado.class, lista);
	...
	public TextField getTxtPercentualRateio() {
		return txtPercentualRateio;
	}

	public void setTxtPercentualRateio(TextField txtPercentualRateio) {
		this.txtPercentualRateio = txtPercentualRateio;
	}
	...
	public ComboBox getCbPlanoCentroResultado() {
		return cbPlanoCentroResultado;
	}
	...
	public void preencheForm(CentroResultado currentBean) {
		...
		getTxtPercentualRateio().setValue(currentBean.getPercentualRateio().toString());
	...
	public void preencheBean(CentroResultado currentBean) {
		...
		BigDecimal perc = (BigDecimal)getTxtPercentualRateio().getConvertedValue();
		currentBean.setDescricao(getTxtDescricao().getValue());
		currentBean.setSofreRateio(getOptSofreRateio().getValue().toString());
		currentBean.setPercentualRateio(perc.doubleValue());
		currentBean.setClassificacao(getTxtClassficacao().getValue());
		currentBean.setPlanoCentroResultado((PlanoCentroResultado) getCbPlanoCentroResultado().getValue());
