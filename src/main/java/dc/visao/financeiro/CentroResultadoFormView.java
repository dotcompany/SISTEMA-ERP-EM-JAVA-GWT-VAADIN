...
public class CentroResultadoFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<PlanoCentroResultado> cmbPlanoCentroResultado;

	public ManyToOneCombo<PlanoCentroResultado> getCmbPlanoCentroResultado() {
		return cmbPlanoCentroResultado;
	}

	public void setCmbPlanoCentroResultado(
			ManyToOneCombo<PlanoCentroResultado> cmbPlanoCentroResultado) {
	...
	private GridLayout buildMainLayout() {
		...
		cmbPlanoCentroResultado = new ManyToOneCombo<>();
