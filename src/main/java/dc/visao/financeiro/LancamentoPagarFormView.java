...
public class LancamentoPagarFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<NaturezaFinanceira> cbNaturezaFinanceira;
	...
	private GridLayout buildFields() {
		...
		fields.addComponent(cbStatusParcela, 2, 3, 3, 3);
	...
	public ManyToOneCombo<NaturezaFinanceira> getCbNaturezaFinanceira() {
		return cbNaturezaFinanceira;
	}

	public void setCbNaturezaFinanceira(
			ManyToOneCombo<NaturezaFinanceira> cbNaturezaFinanceira) {
