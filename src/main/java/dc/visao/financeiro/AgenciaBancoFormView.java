...
public class AgenciaBancoFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<Banco> cmbBanco;
	...
	AgenciaBancoFormController controller;
	...
	public ManyToOneCombo<Banco> getCmbBanco() {
		return cmbBanco;
	}

	public void setCmbBanco(ManyToOneCombo<Banco> cmbBanco) {
		this.cmbBanco = cmbBanco;
	}
	...
	public void InitCbs(List<Banco> banco, List<UF> uf) {
		...
		// BeanItemContainer<UF> objects2 = new BeanItemContainer<UF>(UF.class,
		// uf);
