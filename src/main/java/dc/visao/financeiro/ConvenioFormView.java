...
public class ConvenioFormView extends CustomComponent {
	...
	private GridLayout buildFields() {
		...
		txtSite.setWidth("-1px");
		txtSite.setHeight("-1px");
		txtSite.setSizeFull();
		fields.addComponent(txtSite, 3, 4);
