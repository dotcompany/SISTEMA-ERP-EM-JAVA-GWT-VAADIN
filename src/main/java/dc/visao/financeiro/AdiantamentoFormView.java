...
public class AdiantamentoFormView extends CustomComponent {
	...
	private ManyToOneCombo<LancamentoPagarEntity> cmbLancamentoPagar;
	...
	public ManyToOneCombo<LancamentoPagarEntity> getCmbLancamentoPagar() {
		return cmbLancamentoPagar;
	}

	public void setCmbLancamentoPagar(
			ManyToOneCombo<LancamentoPagarEntity> cmbLancamentoPagar) {
