...
public class ContaCaixaFormView extends CustomComponent {
	...
	private VerticalLayout buildVerticalLayout_1() {
		...
		cmbAgenciaBanco.setCaption("Ag�ncia Banco");
	...
	public void InitCbs(List<ContabilConta> conta, List<AgenciaBanco> agencia) {
		BeanItemContainer<ContabilConta> objects = new BeanItemContainer<ContabilConta>(ContabilConta.class, conta);
		cmbContabilConta.setContainerDataSource(objects);
		
		BeanItemContainer<AgenciaBanco> objects2 = new BeanItemContainer<AgenciaBanco>(AgenciaBanco.class, agencia);
