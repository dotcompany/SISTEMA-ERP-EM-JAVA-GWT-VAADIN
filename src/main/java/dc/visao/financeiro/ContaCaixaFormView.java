...
public class ContaCaixaFormView extends CustomComponent {
	...
	private ManyToOneCombo<AgenciaBancoEntity> cmbAgenciaBanco;
	...
	private VerticalLayout buildVerticalLayout_1() {
		...
		// cmbAgenciaBanco
		cmbAgenciaBanco = new ManyToOneCombo<>();
	...
	public void InitCbs(List<String> contaCaixaTipoList) {
		...
		for (String str : contaCaixaTipoList) {
			cmbTipo.addItem(str.toString());
		}
	}

	/*
	 * public String getCbTipo() { String cbvalue = new String(); if
	 * (cmbTipo.getValue() == "Corrente") { cbvalue = "C"; } else if
	 * (cmbTipo.getValue() == "Poupança") { cbvalue = "P"; } else if
	 * (cmbTipo.getValue() == "Investimento") {
	 * 
	 * cbvalue = "I"; } else if (cmbTipo.getValue() == "Caixa Interno") {
	 * 
	 * cbvalue = "X"; } return cbvalue; }
	 */

	/*
	 * public void setCbTipo(String cbTipo) { if (cbTipo.equalsIgnoreCase("C"))
	 * { this.cmbTipo.setValue("Corrente"); } else if
	 * (cbTipo.equalsIgnoreCase("P")) { this.cmbTipo.setValue("Poupança"); }
	 * else if (cbTipo.equalsIgnoreCase("I")) {
	 * 
	 * this.cmbTipo.setValue("Investimento"); } else if
	 * (cbTipo.equalsIgnoreCase("X")) {
	 * 
	...
	/*
	 * public ManyToOneCombo<AgenciaBanco> getCmbAgenciaBanco() { return
	 * cmbAgenciaBanco; }
	 * 
	 * public void setCmbAgenciaBanco(ManyToOneCombo<AgenciaBanco>
	 * cmbAgenciaBanco) { this.cmbAgenciaBanco = cmbAgenciaBanco; }
	 * 
	 * public ManyToOneCombo<ContabilConta> getCmbContabilConta() { return
	 * cmbContabilConta; }
	 * 
	 * public void setCmbContabilConta( ManyToOneCombo<ContabilConta>
    ...
    public ManyToOneCombo<AgenciaBancoEntity> getCmbAgenciaBanco() {
		return cmbAgenciaBanco;
	}

	public void setCmbAgenciaBanco(ManyToOneCombo<AgenciaBancoEntity> cmbAgenciaBanco) {
	...
	/*public void carregarCmbBem(List<ContabilConta> lista) {
		BeanItemContainer<ContabilConta> bic = new BeanItemContainer<ContabilConta>(
				ContabilConta.class, lista);
		this.cmbContabilConta.setContainerDataSource(bic);
		this.cmbContabilConta.setItemCaptionPropertyId("descricao");
	}
	...
	public void setCmbAgenciaBanco(ComboBox cmbAgenciaBanco) {
		this.cmbAgenciaBanco = cmbAgenciaBanco;
	}

	public ComboBox getCmbContabilConta() {
		return cmbContabilConta;
	}
	...
	public void carregarCmbTipoMovimentacao(List<AgenciaBanco> lista) {
		BeanItemContainer<AgenciaBanco> bic = new BeanItemContainer<AgenciaBanco>(
				AgenciaBanco.class, lista);
		this.cmbAgenciaBanco.setContainerDataSource(bic);
		this.cmbAgenciaBanco.setItemCaptionPropertyId("nome");
	}*/
