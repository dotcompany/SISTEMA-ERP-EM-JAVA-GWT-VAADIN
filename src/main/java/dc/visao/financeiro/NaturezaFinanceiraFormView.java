...
public class NaturezaFinanceiraFormView extends CustomComponent {
	...
	@AutoGenerated
	private ComboBox cbPlanoNaturezaFinanceira;
	@AutoGenerated
	private ComboBox cbContabilConta;
	 ...
	 * editor.
	 */
	public NaturezaFinanceiraFormView() {
		buildMainLayout();
	...
	private HorizontalLayout buildHorizontalLayout_3() {
		...
		cbPlanoNaturezaFinanceira = ComponentUtil.buildComboBox("Plano Natureza Financeira");
		cbPlanoNaturezaFinanceira.setWidth("-1px");
		cbPlanoNaturezaFinanceira.setHeight("-1px");
		cbPlanoNaturezaFinanceira.setItemCaptionPropertyId("nome");
		horizontalLayout_3.addComponent(cbPlanoNaturezaFinanceira);

		// cbContabilConta
		cbContabilConta = ComponentUtil.buildComboBox("Contabil Conta");
		cbContabilConta.setWidth("-1px");
		cbContabilConta.setHeight("-1px");
		cbContabilConta.setItemCaptionPropertyId("descricao");
		horizontalLayout_3.addComponent(cbContabilConta);

		return horizontalLayout_3;
	}

	public void InitCbs(List<PlanoNaturezaFinanceira> lista, List<ContabilConta> lista2) {
		BeanItemContainer<PlanoNaturezaFinanceira> objects = new BeanItemContainer<PlanoNaturezaFinanceira>(PlanoNaturezaFinanceira.class, lista);
		cbPlanoNaturezaFinanceira.setContainerDataSource(objects);

		BeanItemContainer<ContabilConta> objects2 = new BeanItemContainer<ContabilConta>(ContabilConta.class, lista2);
		cbContabilConta.setContainerDataSource(objects2);
	...
	public ComboBox getCbPlanoNaturezaFinanceira() {
		return cbPlanoNaturezaFinanceira;
	}

	public void setCbPlanoNaturezaFinanceira(ComboBox cbPlanoNaturezaFinanceira) {
		this.cbPlanoNaturezaFinanceira = cbPlanoNaturezaFinanceira;
	}

	public ComboBox getCbContabilConta() {
		return cbContabilConta;
	}

	public void setCbContabilConta(ComboBox cbContabilConta) {
	...
	public void preencheBean(NaturezaFinanceira currentBean) {
		...
		currentBean.setPlanoNaturezaFinanceira((PlanoNaturezaFinanceira) getCbPlanoNaturezaFinanceira().getValue());
		currentBean.setContabilconta((ContabilConta) getCbContabilConta().getValue());
	...
	public void preencheForm(NaturezaFinanceira currentBean) {
		...
		getCbPlanoNaturezaFinanceira().setValue(currentBean.getPlanoNaturezaFinanceira());
		getCbContabilConta().setValue(currentBean.getContabilconta());
		getCkContasPagar().setValue(setCksValue(currentBean.getAparecePagar(), "S", "N"));
		getCkContasReceber().setValue(setCksValue(currentBean.getApareceReceber(), "S", "N"));

	}

	private Boolean setCksValue(String value, String valueChecked, String valueNotChecked) {
