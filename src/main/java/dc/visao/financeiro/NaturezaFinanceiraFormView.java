...
public class NaturezaFinanceiraFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<PlanoNaturezaFinanceira> cbPlanoNaturezaFinanceira;
	@AutoGenerated
	...
	public void preencheBean(NaturezaFinanceira currentBean) {
		...
		currentBean.setPlanoNaturezaFinanceira(getCbPlanoNaturezaFinanceira().getValue());
	...
	public ManyToOneCombo<PlanoNaturezaFinanceira> getCbPlanoNaturezaFinanceira() {
		return cbPlanoNaturezaFinanceira;
	}

	public void setCbPlanoNaturezaFinanceira(ManyToOneCombo<PlanoNaturezaFinanceira> cbPlanoNaturezaFinanceira) {
