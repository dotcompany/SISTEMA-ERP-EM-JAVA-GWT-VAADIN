...
public class EmpresaFormView extends CustomComponent {
	...
	private SubFormComponent<Endereco, Integer> buildEnderecoSubForm() {
		enderecoSubForm = new SubFormComponent<Endereco, Integer>(Endereco.class, new String[] { "logradouro", "numero", "complemento", "bairro",
	...
	public void setEnderecoSubForm(SubFormComponent<Endereco, Integer> enderecoSubForm) {
