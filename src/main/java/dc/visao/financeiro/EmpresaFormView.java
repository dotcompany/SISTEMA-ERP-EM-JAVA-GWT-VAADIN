...
public class EmpresaFormView extends CustomComponent {
	...
	private static final Object DISCRIPTION_PROPERTY = "descricao";
	...
	@AutoGenerated
	private SubFormComponent<PessoaEndereco, Integer> enderecoSubForm;
	...
	public VerticalLayout montaAbaSeguimentos() {
		...
		vltSeguimentos.setMargin(false);
		...
		adicionaSeguimento.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if (seguimento != null && !tableSeguimentos.containsId(seguimento.getId())) {
					tableSeguimentos.addItem(seguimento);
				}
			}
		});
		...
		tableSeguimentos.addContainerProperty(NAME_PROPERTY, String.class, "");
		tableSeguimentos.addContainerProperty(DISCRIPTION_PROPERTY, String.class, "");
	...
	/*private SubFormComponent<Contato, Integer> buildContatoSubForm() {
		contatoSubForm = new SubFormComponent<Contato, Integer>(Contato.class, new String[] { "nome", "email", "foneComercial", "foneResidencial",
				"foneCelular" }, new String[] { "Nome", "Email", "Fone Comercial", "Fone Residencial", "Celular" }) {
			String mascaraFone = "(##)####-####";
	...
	private SubFormComponent<PessoaEndereco, Integer> buildEnderecoSubForm() {
		enderecoSubForm = new SubFormComponent<PessoaEndereco, Integer>(PessoaEndereco.class, new String[] { "logradouro", "numero", "complemento", "bairro",
			...
			protected PessoaEndereco getNovo() {
				PessoaEndereco endereco = controller.novoEndereco();
				return endereco;
			}

			protected void getRemoverSelecionados(List<PessoaEndereco> values) {
	...
	private AbsoluteLayout buildAbsoluteLayout_2() {
		...
		absoluteLayout_2.addComponent(absoluteLayout_5, "top:-2.0px;left:-1.0px;");
	...
	private AbsoluteLayout buildAbsoluteLayout_5() {
		...
		absoluteLayout_5.addComponent(dtInicioAtividades, "top:20.0px;left:25.0px;");
		...
		absoluteLayout_5.addComponent(txtInscricaoEstadual, "top:19.0px;left:360.0px;");
		...
		absoluteLayout_5.addComponent(txtInscricaoEstadualSt, "top:19.0px;left:520.0px;");
		...
		absoluteLayout_5.addComponent(txtInscricaoMunicipal, "top:19.0px;left:680.0px;");
		...
		absoluteLayout_5.addComponent(txtInscricaoJuntaComercial, "top:20.0px;left:839.0px;");
		...
		absoluteLayout_5.addComponent(dtInscricaoJuntaComercial, "top:21.0px;left:1000.0px;");
		...
		absoluteLayout_5.addComponent(cmbTipoRegime, "top:60.0px;left:180.0px;");
		...
		absoluteLayout_5.addComponent(txtCodigoTerceiros, "top:96.0px;left:25.0px;");
		...
		absoluteLayout_5.addComponent(txtAliquotaPis, "top:96.0px;left:360.0px;");
		...
		absoluteLayout_5.addComponent(txtAliquotaCofins, "top:96.0px;left:520.0px;");
		...
		absoluteLayout_5.addComponent(txtAliquotaSat, "top:96.0px;left:680.0px;");
		...
		absoluteLayout_5.addComponent(txtCnaePrincipal, "top:146.0px;left:180.0px;");
	...
	public void setDtInscricaoJuntaComercial(PopupDateField dtInscricaoJuntaComercial) {
	...
	public void setTxtInscricaoJuntaComercial(TextField txtInscricaoJuntaComercial) {
	...
	public void setContatoSubForm(SubFormComponent<Contato, Integer> contatoSubForm) {
		this.contatoSubForm = contatoSubForm;
	}*/

	public SubFormComponent<PessoaEndereco, Integer> getEnderecoSubForm() {
		return enderecoSubForm;
	}

	public void setEnderecoSubForm(SubFormComponent<PessoaEndereco, Integer> enderecoSubForm) {
	...
	public void fillEnderecoSubForm(List<PessoaEndereco> enderecos) {
	...
	public void preencheEmpresa(Empresa empresa) {
		...
		empresa.setInscricaoJuntaComercial(getTxtInscricaoJuntaComercial().getValue());
	...
	public void preencheEmpresaForm(Empresa empresa) {
		...
		getTxtInscricaoJuntaComercial().setValue(empresa.getInscricaoJuntaComercial());
