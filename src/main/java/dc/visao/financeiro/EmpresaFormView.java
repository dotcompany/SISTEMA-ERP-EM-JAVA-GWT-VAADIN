...
public class EmpresaFormView extends CustomComponent {
	...
	public VerticalLayout montaAbaSeguimentos() {
							...
							new ConfirmDialog.Listener() {
								...
								public void onClose(ConfirmDialog dialog) {
									if (dialog.isConfirmed()) {
										try {
											seguimentoContainer.removeItem(empresaSeguimentoSelecionado);
		...
		tableSeguimentos.addItemClickListener(new ItemClickListener() {
			...
			public void itemClick(ItemClickEvent event) {
				empresaSeguimentoSelecionado = seguimentoContainer.getItem(event.getItemId()).getBean();
	...
	public void addSeguimento(EmpresaSeguimento empresaSeguimento) {
		if (empresaSeguimento != null && !seguimentoContainer.containsId(empresaSeguimento.getId())) {
