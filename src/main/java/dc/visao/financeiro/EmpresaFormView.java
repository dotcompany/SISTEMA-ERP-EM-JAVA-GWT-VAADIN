...
//		layout.setSizeFull();
	    ...
	    layout.setMargin(true);
		//	layout.addComponent(txtNomeFantasia, 2, 0,3,0);
...
//         subForms.addTab(layout, "Dados Gerais", null);
				...
				return new TableFieldFactory() {
					...
					public Field<?> createField(Container container,
						...
						if ("logradouro".equals(propertyId)) {
							...
							TextField textField = ComponentUtil.buildTextField("CEP");
	...
	private GridLayout montaLayout() {
		...
		layout.addComponent(cmbCrt,4,1);
		
		txtContato = ComponentUtil.buildTextField("Contato");
		layout.addComponent(txtContato,5,1);
		...
		// txtCodigoCps
				txtCodigoCps = ComponentUtil.buildTextField("Código GPS");
				layout.addComponent(txtCodigoCps,0,3);
