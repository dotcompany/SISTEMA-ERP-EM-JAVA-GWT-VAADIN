...
public class EmpresaFormView extends CustomComponent {
	...
	private ManyToOneCombo<SeguimentoEntity> mocSeguimentos;
	...
	public ManyToOneCombo<SeguimentoEntity> getMocSeguimentos() {
		return mocSeguimentos;
	}

	public void setMocSeguimentos(
			ManyToOneCombo<SeguimentoEntity> mocSeguimentos) {
		this.mocSeguimentos = mocSeguimentos;
	}
	...
	public VerticalLayout montaAbaSeguimentos() {
		...
		mocSeguimentos = new ManyToOneCombo<SeguimentoEntity>();
		mocSeguimentos.setCaption("Seguimento");
		mocSeguimentos.setWidth("400px");
		mocSeguimentos.setHeight("-1px");

		hl.addComponent(mocSeguimentos);
		...
		adicionaSeguimento.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				SeguimentoEntity seguimento = (SeguimentoEntity) mocSeguimentos
						.getValue();
