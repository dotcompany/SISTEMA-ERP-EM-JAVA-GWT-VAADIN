...
public class EmpresaFormView extends CustomComponent {
	...
	private SubFormComponent<PessoaEnderecoEntity, Integer> buildEnderecoSubForm() {
		enderecoSubForm = new SubFormComponent<PessoaEnderecoEntity, Integer>(PessoaEnderecoEntity.class, new String[] { "logradouro", "numero", "complemento",
			...
			protected void getRemoverSelecionados(List<PessoaEnderecoEntity> values) {
	...
	public void setEnderecoSubForm(SubFormComponent<PessoaEnderecoEntity, Integer> enderecoSubForm) {
