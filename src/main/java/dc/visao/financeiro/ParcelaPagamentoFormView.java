...
public class ParcelaPagamentoFormView extends CustomComponent {
	...
	private ManyToOneComboField<StatusParcela> cbStatusParcela;
	...
	private GridLayout buildFields() {
		...
		cbStatusParcela= new ManyToOneComboField<>(StatusParcela.class);
	...
	public ManyToOneComboField<StatusParcela> getCbStatusParcela() {
		return cbStatusParcela;
	}

	public void setCbStatusParcela(ManyToOneComboField<StatusParcela> cbStatusParcela) {
