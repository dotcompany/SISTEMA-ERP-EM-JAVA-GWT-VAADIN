...
public class ParcelaPagamentoFormView extends CustomComponent {
	...
	public ParcelaPagamentoFormView(
			ParcelaPagamentoFormController parcelaPagamentoFormController) {
		buildMainLayout();
	...
	private SubFormComponent<ParcelaPagamento, Integer> buildSubFormParcelaPagamento() {
		...
		String[] atributos = new String[] { "tipoPagamento", "dataPagamento",
				"taxaJuro", "valorJuro", "taxaMulta", "valorMulta",
				"taxaDesconto", "valorDesconto", "valorPago", "historico" };

		String[] headers = new String[] { "Tipo Pagamento", "Data Pagamento",
				"Taxa Juro", "Valor Juro", "Taxa Multa", "Valor Multa",
				"Taxa Desconto", "Valor Desconto", "Valor Pago", "Histórico" };

		this.pagamentosSubForm = new SubFormComponent<ParcelaPagamento, Integer>(
				ParcelaPagamento.class, atributos, headers) {
	...
	public void preencheBean(ParcelaPagamento currentBean) {
		...
		currentBean
				.setTipoPagamento((TipoPagamento) cbTipoPagamento.getValue());
		...
		currentBean
				.setValorMulta((BigDecimal) txValorMulta.getConvertedValue());
		currentBean.setTaxaDesconto((BigDecimal) txTaxaDesconto
				.getConvertedValue());
		currentBean.setValorDesconto((BigDecimal) txValorDesconto
				.getConvertedValue());
	...
	public void preencheForm(ParcelaPagamento currentBean) {
		dtDataVencimento.setValue(currentBean.getParcelaPagar()
				.getDataVencimento());
		dtDataPagamento.setValue(currentBean.getDataPagamento());
		txValorPagar
				.setConvertedValue(currentBean.getParcelaPagar().getValor());
	...
	public void setPagamentosSubForm(
			SubFormComponent<ParcelaPagamento, Integer> pagamentosSubForm) {
		this.pagamentosSubForm = pagamentosSubForm;
	}

	public void fillParcelaPagamentosSubForm(
			List<ParcelaPagamento> parcelasPagar) {
	...
	public void preencheComboTipoPagamento(List<TipoPagamento> values) {
		cbTipoPagamento.removeAllItems();

		for (TipoPagamento value : values) {
			cbTipoPagamento.addItem(value);
		}
	}

	public void preencheComboContaCaixa(List<ContaCaixa> values) {
		cbContaCaixa.removeAllItems();

		for (ContaCaixa value : values) {
			cbContaCaixa.addItem(value);
		}
