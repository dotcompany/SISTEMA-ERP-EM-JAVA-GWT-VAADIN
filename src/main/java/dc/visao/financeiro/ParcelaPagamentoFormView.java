...
public class ParcelaPagamentoFormView extends CustomComponent {
	...
	private ManyToOneComboField<TipoPagamento> cbTipoPagamento;
	...
	private GridLayout buildFields() {
		...
		cbTipoPagamento = new ManyToOneComboField<>(TipoPagamento.class);
	...
	public void preencheBean(ParcelaPagar currentBean) {
		//pagamento.setDataPagamento(dtDataPagamento.getValue());
		currentBean.setContaCaixa((ContaCaixa) cbContaCaixa.getValue());
		//pagamento.setTipoPagamento((TipoPagamento) cbTipoPagamento.getValue());
		...
		//pagamento.setValorPago((BigDecimal) txValorPago.getConvertedValue());
		//pagamento.setHistorico(txaHistorico.getValue());
	}

	public void preencheForm(ParcelaPagar currentBean) {
		dtDataVencimento.setValue(currentBean.getDataVencimento());
		//dtDataPagamento.setValue(pagamento.getDataPagamento());
	   ...
	   // if(pagamento.getTipoPagamento() != null){		
		//	cbTipoPagamento.setValue(pagamento.getTipoPagamento());
		//}
		...
		//txValorPago.setConvertedValue(pagamento.getValorPago());
		//txaHistorico.setValue(pagamento.getHistorico());
	...
	public ManyToOneComboField<TipoPagamento> getCbTipoPagamento() {
		return cbTipoPagamento;
	}

	public void setCbTipoPagamento(ManyToOneComboField<TipoPagamento> cbTipoPagamento) {
