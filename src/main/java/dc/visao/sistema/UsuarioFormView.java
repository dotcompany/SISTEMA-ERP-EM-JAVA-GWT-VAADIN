...
public class UsuarioFormView extends CustomComponent {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				try {
					...
					if (event.getProperty() != null && event.getProperty().getValue() != null) {
						ColaboradorEntity colaborador = comboColaborador.getItemValueBean((ItemValue) event.getProperty().getValue());
	...
	public void setComboColaborador(ManyToOneCombo<ColaboradorEntity> comboColaborador) {
