...
public class ContaFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<PlanoContaRefSpedEntity> cbPlanoContaRefSped;
	...
	public ManyToOneCombo<PlanoContaRefSpedEntity> getCbPlanoContaRefSped() {
		return cbPlanoContaRefSped;
	}

	public void setCbPlanoContaRefSped(
			ManyToOneCombo<PlanoContaRefSpedEntity> cbPlanoContaRefSped) {
