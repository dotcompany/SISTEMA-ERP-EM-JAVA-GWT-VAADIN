...
public class IndiceFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<IndiceEconomicoEntity> cbIndiceEconomico;
	...
	public ManyToOneCombo<IndiceEconomicoEntity> getCbIndiceEconomico() {
		return cbIndiceEconomico;
	}

	public void setCbIndiceEconomico(
			ManyToOneCombo<IndiceEconomicoEntity> cbIndiceEconomico) {
	...
	private GridLayout buildGridLayout_1() {
		...
		// cbIndiceEconomico
		cbIndiceEconomico = new ManyToOneCombo<>();
		cbIndiceEconomico.setCaption("Índice econômico:");
		cbIndiceEconomico.setImmediate(false);
		cbIndiceEconomico.setWidth("175px");
		cbIndiceEconomico.setHeight("-1px");
		cbIndiceEconomico.setSizeFull();
		gridLayout_1.addComponent(cbIndiceEconomico, 1, 2);
