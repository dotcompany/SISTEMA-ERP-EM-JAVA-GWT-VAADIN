...
public class IndiceFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<IndiceEconomico> cbIndiceEconomico;
	...
	public ManyToOneCombo<IndiceEconomico> getCbIndiceEconomico() {
		return cbIndiceEconomico;
	}

	public void setCbIndiceEconomico(
			ManyToOneCombo<IndiceEconomico> cbIndiceEconomico) {
