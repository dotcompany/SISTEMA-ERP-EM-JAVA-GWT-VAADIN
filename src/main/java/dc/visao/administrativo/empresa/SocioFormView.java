...
public class SocioFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<QuadroSocietarioEntity> cmbQuadroSocietario;
	
	@AutoGenerated
	private ManyToOneCombo<UfEntity> cmbUF;
	...
	private GridLayout buildFields() {
		...
		cmbQuadroSocietario = new ManyToOneCombo<>();
	...
	public ManyToOneCombo<QuadroSocietarioEntity> getCmbQuadroSocietario() {
		return cmbQuadroSocietario;
	}

	public void setCmbQuadroSocietario(ManyToOneCombo<QuadroSocietarioEntity> cmbQuadroSocietario) {
	...
	public ManyToOneCombo<UfEntity> getCmbUF() {
		return cmbUF;
	}

	public void setCmbUF(ManyToOneCombo<UfEntity> cmbUF) {
		this.cmbUF = cmbUF;
	}
