...
public class EmpresaFormView extends CustomComponent {
	...
	public EmpresaSeguimento getEmpresaSeguimentoSelecionado() {
		return empresaSeguimentoSelecionado;
	}

	public void setEmpresaSeguimentoSelecionado(
			EmpresaSeguimento empresaSeguimentoSelecionado) {
		this.empresaSeguimentoSelecionado = empresaSeguimentoSelecionado;
	}
	...
	public VerticalLayout montaAbaEmpresaSeguimento() {
		...
		adicionaSeguimento.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				controller.aderirEmpresaSeguimento();
			}
		...
		//tableEmpresaSeguimento = new Table();
		//tableEmpresaSeguimento.setSizeFull();
		// seguimentoContainer = new
		// BeanItemContainer<>(EmpresaSeguimento.class);
		// tableEmpresaSeguimento.setContainerDataSource(seguimentoContainer);
		//tableEmpresaSeguimento.setColumnCollapsingAllowed(true);
		//tableEmpresaSeguimento.setImmediate(true);
		//tableEmpresaSeguimento.setEditable(false);
		//tableEmpresaSeguimento.setSelectable(true);
		...
		//tableEmpresaSeguimento.addItemClickListener(new ItemClickListener() {
		...
		//vltEmpresaSeguimento.setExpandRatio(hl, 1f);
		//vltEmpresaSeguimento.setExpandRatio(tableEmpresaSeguimento, 3f);
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		// cbMatriz.setContainerDataSource(controller.carregarMatrizes());
	...
	private TabSheet buildTabForm() {
		...
		sfPessoaEndereco = buildPessoaEnderecoSubForm();
		// tabForm.addTab(contatoSubForm, "Contato", null);
		tabForm.addTab(sfPessoaEndereco, "Endereço", null);
		tabForm.addTab(montaAbaEmpresaSeguimento(), "Seguimento", null);
	...
	public void fillEnderecoSubForm(
	...
	//public Table getTableEmpresaSeguimento() {
	//	return tableEmpresaSeguimento;
	//}

	//public void setTableEmpresaSeguimento(Table tableEmpresaSeguimento) {
	//	this.tableEmpresaSeguimento = tableEmpresaSeguimento;
	//}
	...
	public List<EmpresaSeguimento> getSeguimento() {
	...
	public void setEmpresaSeguimentoList(
		...
		for (EmpresaSeguimento empresaSeguimento : empresaSeguimentoList) {
	...
	private SubFormComponent<EmpresaSeguimento, Integer> buildEmpresaSeguimentoSubForm() {
		...
		sfEmpresaSeguimento = new SubFormComponent<EmpresaSeguimento, Integer>(
				EmpresaSeguimento.class,
				new String[] { "empresa", "seguimento" }, new String[] {
						"Empresa", "Seguimento" }) {
