...
public class ContratosFormView extends CustomComponent {
	...
	@AutoGenerated
	private TextField txtMunicipioObjeto;
	@AutoGenerated
	private ManyToOneCombo<UF> cmbEstadoObjeto;
	...
	private GridLayout buildGridLayout_4() {
		...
		txtNumeroObjeto = ComponentUtil.buildNumericField("Município Ibge");
		txtNumeroObjeto.setConverter(new IntegerConverter());
		txtNumeroObjeto.setMaxLength(10);
		gridLayout_4.addComponent(txtNumeroObjeto, 1, 3);
		
		cmbEstadoObjeto = new ManyToOneCombo<>();
		cmbEstadoObjeto.setCaption("UF");
		cmbEstadoObjeto.setSizeFull();
		gridLayout_4.addComponent(cmbEstadoObjeto, 2, 3);
