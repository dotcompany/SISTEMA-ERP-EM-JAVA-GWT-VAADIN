...
public class ContratosFormView extends CustomComponent {
	...
	private DefaultManyToOneComboModel<Produto> model= new DefaultManyToOneComboModel<Produto>(ProdutosListController.class,produtoDAO,mainController);
				...
				return new TableFieldFactory() {
					...
					public Field<?> createField(Container container, Object itemId, Object propertyId, Component uiContext) {
						...
						if ("produto.nome".equals(propertyId)) {
							...
							ComboBox cmbProduto = new ComboBox();
							cmbProduto.setImmediate(true);
							cmbProduto.setSizeFull();
							cmbProduto.setStyleName("manyToOneCombo");
							
						    List<Produto> list = model.getAll();
						    for (Produto val : list) {
								cmbProduto.setValue(val);
							}
