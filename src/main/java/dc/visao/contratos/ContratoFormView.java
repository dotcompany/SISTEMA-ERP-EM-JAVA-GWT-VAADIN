...
public class ContratoFormView extends CustomComponent {
	...
	private Component buildArquivoContratoSubForm() {
	    ...
	    controller.createResource().getStreamSource().getStream();

		contratoLayout.addComponent(this.arquivoContratoSubForm);
		contratoLayout.setExpandRatio(arquivoContratoSubForm, 3);
