...
public class ContratoFormView extends CustomComponent {
	...
	public RichTextArea getTxaTemplate() {
		return txaTemplate;
	}

	public void setTxaTemplate(RichTextArea txaTemplate) {
		this.txaTemplate = txaTemplate;
	}
	...
	private TabSheet buildTabSheet_1() {
		...
		tabSheet_1.addTab(gridLayout_3, "Arquivo Contrato", null);
