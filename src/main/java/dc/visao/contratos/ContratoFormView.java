...
public class ContratoFormView extends CustomComponent {
	...
	@AutoGenerated
	private RichTextArea txaTemplate;
	@AutoGenerated
	private Button btnArquivoContrato;
	...
	private GridLayout buildGridLayout_2() {
		...
		btnArquivoContrato = new Button("Arquivo Contrato");
		btnArquivoContrato.setSizeFull();
		btnArquivoContrato.setVisible(true);
		gridLayout_2.addComponent(btnArquivoContrato, 2, 2);
	...
	private TabSheet buildTabSheet_2() {
		...
		//tabSheet_2.addTab(buildArquivoContratoSubForm(), "Arquivo Contrato", null);
	...
	public Button getBtnArquivoContrato() {
		return btnArquivoContrato;
	}

	public void setBtnArquivoContrato(Button btnArquivoContrato) {
		this.btnArquivoContrato = btnArquivoContrato;
	}
	...
	public SubFormComponent<Documento, Integer> getArquivoContratoSubForm() {
		return arquivoContratoSubForm;
	}

	public void setArquivoContratoSubForm(
			SubFormComponent<Documento, Integer> arquivoContratoSubForm) {
		this.arquivoContratoSubForm = arquivoContratoSubForm;
	}
