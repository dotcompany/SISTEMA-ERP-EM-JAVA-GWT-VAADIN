...
public class ContratoFormView extends CustomComponent {
	...
	/*private Component buildHistoricoReajustesSubForm() {
		String[] atributos = new String[] { "indice", "valorAnterior", "valorAtual", "dataReajustes", "observacao" };
		String[] headers = new String[] { "Índice", "Valor Anterior", "Valor Atual", "Data Reajustes", "Observação" };

		this.historicoReajustesSubForm = new SubFormComponent<ContratoHistoricoReajuste, Integer>(ContratoHistoricoReajuste.class, atributos, headers) {
	...
	/*private Component buildHistoricoFaturamentoSubForm() {
		String[] atributos = new String[] { "dataFatura", "valor" };
		String[] headers = new String[] { "Data Fatura", "Valor" };

		this.historicoFaturamentoSubForm = new SubFormComponent<ContratoHistFaturamento, Integer>(ContratoHistFaturamento.class, atributos, headers) {
	...
	/*private Component buildPrevisaoFaturamentoSubForm() {
		...
		String[] atributos = new String[] { "numeroParcela", "dataPrevista", "valor" };

		String[] headers = new String[] { "Número Parcela", "Data Prevista", "Valor"};
	...
	public SubFormComponent<ContratoPrevFaturamento, Integer> buildPrevisaoFaturamentoSubForm() {
		SubFormComponent<ContratoPrevFaturamento, Integer> subForm = new SubFormComponent<ContratoPrevFaturamento, Integer>(
				ContratoPrevFaturamento.class, new String[] { "pessoa", "dataPrevista", "valor" }, new String[] { "Pessoa", "Data Prevista", "Valor" }) {
