...
public class ContratoFormView extends CustomComponent {
	...
	private VerticalLayout gridLayout_3;
	@AutoGenerated
	...
	@AutoGenerated
	private VerticalLayout buildGridLayout_3() {
		// common part: create layout
		gridLayout_3 = new VerticalLayout();
		//gridLayout_3.setRows(1);
		...
		gridLayout_3.addComponent(txaTemplate);
