...
public class ContratoSolicitacaoServicoFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<ContratoTipoServico> cbTipoServico;
	@AutoGenerated
	private ManyToOneCombo<Colaborador> cbColaborador;
	@AutoGenerated
	private ManyToOneCombo<Setor> cbSetor;
	@AutoGenerated
	...
	public void preencherObjeto(final ContratoSolicitacaoServico currentBean) {
		...
		currentBean.setCliente((Cliente) cbCliente.getValue());
		currentBean.setSetor((Setor) cbSetor.getValue());
		currentBean.setColaborador((Colaborador) cbColaborador.getValue());
		currentBean.setContratoTipoServico((ContratoTipoServico) cbTipoServico.getValue());
	...
	public ManyToOneCombo<ContratoTipoServico> getCbTipoServico() {
		return cbTipoServico;
	}

	public void setCbTipoServico(ManyToOneCombo<ContratoTipoServico> cbTipoServico) {
		this.cbTipoServico = cbTipoServico;
	}

	public ManyToOneCombo<Colaborador> getCbColaborador() {
		return cbColaborador;
	}

	public void setCbColaborador(ManyToOneCombo<Colaborador> cbColaborador) {
		this.cbColaborador = cbColaborador;
	}

	public ManyToOneCombo<Setor> getCbSetor() {
		return cbSetor;
	}

	public void setCbSetor(ManyToOneCombo<Setor> cbSetor) {
