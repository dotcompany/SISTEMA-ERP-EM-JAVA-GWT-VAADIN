...
* @author Wesley Jr
/*
 * Essa classe ï¿½ a classe principal da Tela (DESIGN), onde nela temos o button, o GRID, onde vai listar
 * algumas informaï¿½ï¿½es de outra Tela e tem tudo correto, uma nova Tela.
 *
*/
...
public class CRUDFormView extends CustomComponent implements View {
	...
	private HorizontalLayout buildHorizontalLayout_3() {
		...
		horizontalLayout_3
				.setComponentAlignment(btnCancelar, new Alignment(34));
	...
	public void setDefaultCloseOperation(int doNothingOnClose) {
		// TODO Auto-generated method stub
		int resposta = JOptionPane.showConfirmDialog(null,"Deseja finalizar essa opera��o?","Finalizar",JOptionPane.YES_NO_OPTION);
