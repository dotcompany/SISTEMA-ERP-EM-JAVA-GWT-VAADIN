...
public class CriaContaController implements Serializable, ViewController {
	...
	public void criarconta(ContaEmpresa c){
		...
		if(saved){
			...
			try {
				sender.send(currentBean.getEmail(), "Bem vindo ao DotCompany ERP", "Bem vindo ao DotCompany ERP.</br> Clique <a href=\"http://www.dotcompanyerp.com.br/online\"> aqui</a> para acessar o sistema </br>",true);
			} catch (Exception e) {
