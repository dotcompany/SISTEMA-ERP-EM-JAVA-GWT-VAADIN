...
public class CRUDListView extends CustomComponent implements View {
	...
	private HorizontalLayout buildHorizontalLayout_4() {
		...
		excelImporter.addListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				excelImporter.processaArquivo((File) upload.getValue(), controller);
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		horizontalLayout_2.setComponentAlignment(horizontalLayout_1, new Alignment(33));
	...
	/*
	 * @AutoGenerated private HorizontalLayout buildHorizontalLayout_5() { //
	 * common part: create layout horizontalLayout_5 = new HorizontalLayout();
	 * horizontalLayout_5.setImmediate(false);
	 * horizontalLayout_5.setWidth("-1px");
	 * horizontalLayout_5.setHeight("-1px");
	 * horizontalLayout_5.setMargin(false); horizontalLayout_1.setSpacing(true);
	 * 
	 * // btnFechar btnFechar = new Button(); btnFechar.setCaption("Fechar");
	 * btnFechar.setImmediate(true); btnFechar.setWidth("-1px");
	 * btnFechar.setHeight("-1px"); horizontalLayout_5.addComponent(btnFechar);
