...
public class RetencaoFormView extends CustomComponent {
	...
	/*
	 * @AutoGenerated private ComboBox cbInss;
	 * 
	 * @AutoGenerated private ComboBox cbServico;
	 */

	@AutoGenerated
	private ManyToOneCombo<InssEntity> cbInss;

	@AutoGenerated
	private ManyToOneCombo<ServicoEntity> cbServico;
	...
	public ManyToOneCombo<InssEntity> getCbInss() {
		return cbInss;
	}

	public void setCbInss(ManyToOneCombo<InssEntity> cbInss) {
		this.cbInss = cbInss;
	}

	public ManyToOneCombo<ServicoEntity> getCbServico() {
		return cbServico;
	}

	public void setCbServico(ManyToOneCombo<ServicoEntity> cbServico) {
	 ...
	 * InssEntity.class, lista); this.cbInss.setContainerDataSource(bic);
	 * this.cbInss.setItemCaptionPropertyId("competencia"); }
	 * 
	 * public void carregarCmbServico(List<ServicoEntity> lista) {
	 * BeanItemContainer<ServicoEntity> bic = new
	 * BeanItemContainer<ServicoEntity>( ServicoEntity.class, lista);
