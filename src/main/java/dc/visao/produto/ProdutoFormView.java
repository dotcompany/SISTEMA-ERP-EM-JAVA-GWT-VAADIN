...
public class ProdutoFormView extends CustomComponent {
	...
	private GridLayout buildFields() {
		...
		cmbIcmsCustomizado.setWidth("100px");
		...
		fields.addComponent(cmbIcmsCustomizado,0,2);
	...
	public void buildValorPrincipalSubForm(){
		...
		txtQuantidadeEstoque = ComponentUtil.buildNumericField("Quantidade Estoque");
		...
		txtQtde = ComponentUtil.buildNumericField("Qtde Estoque Anterior");
		txtQtde.setHeight("-1px");
		txtQtde.setHeight("-1px");
		txtQtde.setWidth("150px");
		
		txtEstoqueIdeal =  ComponentUtil.buildNumericField("Estoque Ideal");
		txtEstoqueIdeal.setHeight("-1px");
		txtEstoqueIdeal.setHeight("-1px");
		txtEstoqueIdeal.setWidth("150px");
		
		txtEstoqueMinimo =  ComponentUtil.buildNumericField("Estoque Minimo");
		txtEstoqueMinimo.setHeight("-1px");
		txtEstoqueMinimo.setHeight("-1px");
		txtEstoqueMinimo.setWidth("150px");
		
		txtEstoqueMaximo =  ComponentUtil.buildNumericField("Estoque Máximo");
		txtEstoqueMaximo.setHeight("-1px");
		txtEstoqueMaximo.setHeight("-1px");
		txtEstoqueMaximo.setWidth("150px");
		
		layout.addComponent(txtQtde,0,2);
	...
	public void buildComplementarSubForm(){
        ...
        txtPeso = ComponentUtil.buildNumericField("Peso");
        txtPeso.setHeight("-1px");
        txtPeso.setWidth("150px"); 
        
        txtTaxaComissao = ComponentUtil.buildNumericField("Taxa Comissão");
        ...
        txtPontoPedido = ComponentUtil.buildNumericField("Ponto Pedido");
        txtPontoPedido.setHeight("-1px");
        txtPontoPedido.setWidth("150px"); 
        
        txtLoteEconomicoCompra = ComponentUtil.buildNumericField("Lote Econômico Compra");
        txtLoteEconomicoCompra.setHeight("-1px");
        txtLoteEconomicoCompra.setWidth("150px"); 
        
        txtAliquotaICms = ComponentUtil.buildNumericField("Aliquota ICMS");
        txtAliquotaICms.setHeight("-1px");
        txtAliquotaICms.setWidth("150px"); 
        
        txtAliquotaIssqn = ComponentUtil.buildNumericField("Aliquota ISSQN");
	...
	public enum TIPO_VENDA {
		...
		VENDA("Venda", "1"), COMPOSICAO("Composição", "2"),PRODUCAO("Produção", "3"),
		INSUMO("Insumo", "4"),USO_PROPRIO("Uso Próprio", "5");
	...
	public enum TIPO_SPED {
		...
		MERCADORIA_PRA_REVENDA("Mercadoria P/Revenda", "00"), MATERIA_PRIMA("Matéria Prima", "01"),
		EMBALAGEM("Embalagem", "02"),PRODUTO_EM_PROCESSO("Produto em Processo", "03"),PRODUTO_ACABADO("Produto Acabado", "04"),
		SUBPRODUTO("SubProduto", "05"),PRODUTO_INTERMEDIARIO("Produto Intermediário", "06"),
