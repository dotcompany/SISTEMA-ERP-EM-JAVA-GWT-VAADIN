...
import dc.controller.produto.ProdutoFormController;
...
//		horizontalLayout_2.addComponent(cmbIcmsCustomizado);
	...
	public void buildPrincipalSubForm(){
		...
		//cmbNcm.setContainerDataSource(controller.carregarNCM());
	...
	public ComboBox getCmbGrupo() {
		return cmbGrupo;
	}

	public void setCmbGrupo(ComboBox cmbGrupo) {
