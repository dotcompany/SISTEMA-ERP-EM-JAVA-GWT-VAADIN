...
public class ProdutosFormView extends CustomComponent {
	...
	TextField txtAliquotaICms, txtAliquotaIssqn, txtLoteEconomicoCompra, txtPontoPedido, txtTaxaComissao;
	
	TextField txtPeso, txtCodigoBalanca, txtTotalizadorParcial, txtExtipi, txtLst, txtEstoqueMaximo;
	
	TextField txtEstoqueMinimo, txtEstoqueIdeal, txtQuantidadeEstoqueAnterior, txtQuantidadeEstoque;
	
	TextField txtMarkup, txtPrecoLucroMaximo, txtPrecoLucroMinimo, txtPrecoLucroZero, txtCustoMedioLiquido;
	
	TextField txtValorSugerido, txtValorVendaMinimo, txtValorVenda, txtValorCompra, txtDescricao, txtDescricaoPdv;
