...
public class ProdutoServicoFormView extends CustomComponent {
	...
	public Panel getPlNdeMedicamentoSubForm() {
	...
	public GridLayout getNdeGlVeiculo() {
		return glNdeVeiculo;
	}
	...
	public GridLayout getNdeGlCombustivel() {
	...
	private Panel bplNdeMedicamentoSubForm() {
		...
		plNdeMedicamentoSubForm.setContent(buildMedicamentoSubForm());
