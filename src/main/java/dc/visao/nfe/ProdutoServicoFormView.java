...
public class ProdutoServicoFormView extends CustomComponent {
	...
	public TextField getTfIdDestinatario() {
		return tfIdDestinatario;
	}

	public void setTfIdDestinatario(TextField tfIdDestinatario) {
		this.tfIdDestinatario = tfIdDestinatario;
	}
	...
	public TextField getTfNomeProduto() {
		return tfNomeProduto;
	}

	public void setTfNomeProduto(TextField tfNomeProduto) {
	...
	private GridLayout bglNfeDetalhe() {
		...
		tfNumeroItem.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfNumeroItem.setValue(ObjectConverter.onlyInteger(event));
		...
		// tfNomeProduto
		tfNomeProduto = new TextField("Nome do produto:");
		tfNomeProduto.setWidth("-1px");
		tfNomeProduto.setHeight("-1px");
		tfNomeProduto.setSizeFull();
		tfNomeProduto.setNullRepresentation("");
		tfNomeProduto.setImmediate(true);
		tfNomeProduto.setId("tfNomeProduto");
		tfNomeProduto.addValueChangeListener(new ValueChangeListener() {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1L;
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				controller.nfeDetalheSetarValor(tfNomeProduto.getId(), event);
			}
		});
		glNfeDetalhe.addComponent(tfNomeProduto, 0, 1);
		...
		tfExTipi.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfExTipi.setValue(ObjectConverter.onlyInteger(event));
		...
		tfCfop.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfCfop.setValue(ObjectConverter.onlyInteger(event));
		...
		tfQuantidadeComercial.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfQuantidadeComercial.setValue(ObjectConverter.onlyValue(event));
		...
		tfValorBrutoProduto.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfValorBrutoProduto.setValue(ObjectConverter.onlyValue(event));

				controller.nfeDetalheSetarValor(tfValorBrutoProduto.getId(),
						event);
			}
		});
		...
		tfUnidadeTributavel.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				controller.nfeDetalheSetarValor(tfUnidadeTributavel.getId(),
						event);
			}
		});
		...
		tfValorFrete.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfValorFrete.setValue(ObjectConverter.onlyValue(event));
		...
		tfValorSeguro.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfValorSeguro.setValue(ObjectConverter.onlyValue(event));

				controller.nfeDetalheSetarValor(tfValorSeguro.getId(), event);
			}
		});
		...
		tfValorDesconto.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfValorDesconto.setValue(ObjectConverter.onlyValue(event));

				controller.nfeDetalheSetarValor(tfValorDesconto.getId(), event);
			}
		});
		...
		tfValorOutrasDespesas.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfValorOutrasDespesas.setValue(ObjectConverter.onlyValue(event));

				controller.nfeDetalheSetarValor(tfValorOutrasDespesas.getId(),
						event);
			}
		});
		...
		tfValorSubtotal.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfValorSubtotal.setValue(ObjectConverter.onlyValue(event));

				controller.nfeDetalheSetarValor(tfValorSubtotal.getId(), event);
			}
		});
		...
		tfValorTotal.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfValorTotal.setValue(ObjectConverter.onlyValue(event));
		...
		tfNumeroPedidoCompra.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				controller.nfeDetalheSetarValor(tfNumeroPedidoCompra.getId(),
						event);
			}
		});
		...
		tfItemPedidoCompra.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				// TODO Auto-generated method stub
				tfItemPedidoCompra.setValue(ObjectConverter.onlyInteger(event));
