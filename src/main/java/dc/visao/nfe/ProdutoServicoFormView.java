...
public class ProdutoServicoFormView extends CustomComponent {
	...
	private TabSheet btsPrincipal() {
		...
		tsPrincipal.addTab(vlNdiIcms, "ICMS", null);

		// gridLayout_15
		vlNdiPis = bvlNdiPis();
		tsPrincipal.addTab(vlNdiPis, "PIS", null);

		// gridLayout_16
		vlNdiCofins = bvlNdiCofins();
		tsPrincipal.addTab(vlNdiCofins, "COFINS", null);

		// gridLayout_17
		vlNdiIpi = bvlNdiIpi();
		tsPrincipal.addTab(vlNdiIpi, "IPI", null);

		// gridLayout_18
		vlNdiIi = bvlNdiIi();
		tsPrincipal.addTab(vlNdiIi, "Imposto importação", null);

		// gridLayout_19
		vlNdiIssqn = bvlNdiIssqn();
		tsPrincipal.addTab(vlNdiIssqn, "ISSQN", null);

		// gridLayout_20
		vlNdeCombustivel = bvlNdeCombustivel();
		tsPrincipal.addTab(vlNdeCombustivel, "Combustível", null);

		// gridLayout_21
		vlNdeVeiculo = bvlNdeVeiculo();
		tsPrincipal.addTab(vlNdeVeiculo, "Veículo", null);

		// gridLayout_1
		vlNdeMedicamento = bvlNdeMedicamento();
		tsPrincipal.addTab(vlNdeMedicamento, "Medicamento", null);

		// gridLayout_2
		vlNdeArmamento = bvlNdeArmamento();
		tsPrincipal.addTab(vlNdeArmamento, "Armamento", null);
	...
	@AutoGenerated
	private VerticalLayout bvlNfeDestinatario() {
		// common part: create layout
