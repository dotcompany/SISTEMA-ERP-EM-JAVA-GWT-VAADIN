...
public class ProdutoServicoFormView extends CustomComponent {
	...
	private VerticalLayout buildVerticalLayout_3() {
		...
		SubFormComponent<ProdutoServicoEntity, Integer> produtoServicoSubForm = new SubFormComponent<ProdutoServicoEntity, Integer>(
				ProdutoServicoEntity.class, new String[] { "parcela", "dias",
						"taxa" }, new String[] { "Parcela", "Dias", "Taxa" }) {
			...
			@Override
			public boolean validateItems(List<ProdutoServicoEntity> items) {
				// TODO Auto-generated method stub
				return true;
			}
		};

		verticalLayout_3.addComponent(produtoServicoSubForm);
