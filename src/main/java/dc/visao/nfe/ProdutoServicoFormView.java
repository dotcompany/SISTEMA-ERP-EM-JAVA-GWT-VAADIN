...
public class ProdutoServicoFormView extends CustomComponent {
	...
	@AutoGenerated
	private Panel pNfeDetalheSelecionado;

	@AutoGenerated
	private GridLayout glNfeDetalheSelecionado;
	...
	private VerticalLayout bvlNfeDetalhe() {
		...
		vlNfeDetalhe.addComponent(bpNfeDetalheSelecionado());
	...
	@AutoGenerated
	private Panel bpNfeDetalheSelecionado() {
		// common part: create layout
		pNfeDetalheSelecionado = new Panel();
		pNfeDetalheSelecionado.setImmediate(false);
		pNfeDetalheSelecionado.setWidth("100.0%");
		pNfeDetalheSelecionado.setHeight("100.0%");
		pNfeDetalheSelecionado.setSizeFull();
		pNfeDetalheSelecionado.setWidth("100.0%");
		pNfeDetalheSelecionado.setHeight("100.0%");

		pNfeDetalheSelecionado.setContent(bglNfeDetalheSelecionado());

		return pNfeDetalheSelecionado;
	}

	@AutoGenerated
	private GridLayout bglNfeDetalheSelecionado() {
		// common part: create layout
		glNfeDetalheSelecionado = new GridLayout();
		glNfeDetalheSelecionado.setImmediate(false);
		// glNfeCabecalhoTotalGeral.setWidth("100.0%");
		// glNfeCabecalhoTotalGeral.setHeight("100.0%");
		glNfeDetalheSelecionado.setSizeFull();
		glNfeDetalheSelecionado.setMargin(true);
		glNfeDetalheSelecionado.setSpacing(true);
		glNfeDetalheSelecionado.setRows(6);
		glNfeDetalheSelecionado.setColumns(4);

		return glNfeDetalheSelecionado;
	}
