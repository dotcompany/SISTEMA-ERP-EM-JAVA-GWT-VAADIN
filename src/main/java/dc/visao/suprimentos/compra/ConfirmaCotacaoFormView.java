...
public class ConfirmaCotacaoFormView extends CustomComponent {
	...
	private SubFormComponent<CotacaoDetalhe, Integer> sbCotacaoDetalhe;
	...
	private GridLayout buildFields() {
		...
		cbFornecedor = ComponentUtil.buildComboBox("Fornecedores");
		cbFornecedor
		...
		cbFornecedor.addValueChangeListener(new ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				FornecedorCotacao fornCotacao = (FornecedorCotacao) cbFornecedor
						.getValue();
		...
		sbCotacaoDetalhe = new SubFormComponent<CotacaoDetalhe, Integer>(
