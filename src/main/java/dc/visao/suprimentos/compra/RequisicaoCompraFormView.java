...
public class RequisicaoCompraFormView extends CustomComponent {
	...
	private SubFormComponent<?, ?> buildSubForms() {
		requisicaoDetalheSubForm = new SubFormComponent<RequisicaoDetalhe, Integer>(
				RequisicaoDetalhe.class,
				new String[] { "produto", "quantidade" }, new String[] {
						"Produto", "Quantidade" }) {
			@Override
			...
			protected RequisicaoDetalhe getNovo() {
				RequisicaoDetalhe requisicaoDetalhe = controller
	...
	public void fillCmbTipoRequisicao(List<TipoRequisicao> lista) {
		BeanItemContainer<TipoRequisicao> tipoRequisicaoContainer = new BeanItemContainer<>(
				TipoRequisicao.class, lista);
