...
public class ContagemEstoqueFormView extends CustomComponent {
	...
	private TabSheet buildSubForms() {
		...
		contagemEstoqueDetalheSubForm = new SubFormComponent<ContagemEstoqueDetalhe, Integer>(
				ContagemEstoqueDetalhe.class, new String[] { "produto",
			...
			protected ContagemEstoqueDetalhe getNovo() {
				ContagemEstoqueDetalhe contagemEstoqueDetalhe = controller
	...
	public void fillContagemEstoqueDetalhesSubForm(
			List<ContagemEstoqueDetalhe> contagemEstoqueDetalhes) {
