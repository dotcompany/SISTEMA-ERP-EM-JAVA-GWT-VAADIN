...
public class MapaComparativoFormView extends CustomComponent {
	...
	public MapaComparativoFormView() {
		buildMainLayout();
	...
	private GridLayout buildFields() {
		...
		txtTaxaDesconto = ComponentUtil.buildPercentageField("Taxa de Desconto");
		...
		cotacaoDetalheSubForm = new SubFormComponent<CotacaoDetalhe, Integer>(CotacaoDetalhe.class, new String[] { "produto.nome",
				"quantidade", "quantidadePedida", "valorUnitario", "valorSubtotal", "taxaDesconto", "valorDesconto", "valorTotal" }, new String[] {
				"Produto requisitado", "Quantidade", "Quantidade a ser pedida", "Valor Unitário", "Valor SubTotal", "Taxa Desconto", "Valor Desconto",
				...
				return new TableFieldFactory() {
					...
					public Field<?> createField(Container container, Object itemId, Object propertyId, Component uiContext) {
						if ("quantidadePedida".equals(propertyId)) {
							...
							return textField;
						} else if ("quantidade".equals(propertyId) || "produto.nome".equals(propertyId) 
								|| "valorUnitario".equals(propertyId) || "valorSubtotal".equals(propertyId)
								|| "valorDesconto".equals(propertyId) || "valorTotal".equals(propertyId)
