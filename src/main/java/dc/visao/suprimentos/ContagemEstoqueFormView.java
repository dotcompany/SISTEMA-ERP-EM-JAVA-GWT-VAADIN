...
public class ContagemEstoqueFormView extends CustomComponent {
	...
	/*public ContagemEstoqueDetalhe novoContagemEstoqueDetalhe() {
		...
		public void fillContagemEstoqueDetalhesSubForm(List<ContagemEstoqueDetalhe> contagemEstoqueDetalhes) {
		...
		public SubFormComponent<ContagemEstoqueDetalhe, Integer> getContagemEstoqueDetalheSubForm() {
			return contagemEstoqueDetalheSubForm;
		}

		public void setContagemEstoqueDetalheSubForm(
				SubFormComponent<ContagemEstoqueDetalhe, Integer> contagemEstoqueDetalheSubForm) {
