...
public class ContratosFormView extends CustomComponent {
	...
	private Component buildPrevisaoFaturamentoSubForm() {
		...
		this.previsaoFaturamentoSubForm = new SubFormComponent<ContratoPrevFaturamento, Integer>(
				ContratoPrevFaturamento.class, atributos, headers) {
	...
	public void preencheContrato(Contrato contrato) {
		...
		contrato.setContratoSolicitacaoServico((ContratoSolicitacaoServico) cmbSolicitacaoServico
				.getValue());
	...
	public void setCmbSolicitacaoServico(
			ManyToOneCombo<ContratoSolicitacaoServico> cmbSolicitacaoServico) {
	...
	public void setHistoricoFaturamentoSubForm(
			SubFormComponent<ContratoHistFaturamento, Integer> historicoFaturamentoSubForm) {
	...
	public void setHistoricoReajustesSubForm(
			SubFormComponent<ContratoHistoricoReajuste, Integer> historicoReajustesSubForm) {
