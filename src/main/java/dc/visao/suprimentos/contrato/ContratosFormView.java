...
public class ContratosFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<SolicitacaoServicoEntity> cmbSolicitacaoServico;
	@AutoGenerated
	private TextField txtNome;
	@AutoGenerated
	private TextField txtNumero;
	@AutoGenerated
	private ManyToOneCombo<PessoaEntity> cbmPessoa;
	@AutoGenerated
	private ManyToOneCombo<ContabilContaEntity> cbmContabilConta;
	@AutoGenerated
	private ManyToOneCombo<TipoContratoEntity> cbmTipoContrato;
	@AutoGenerated
	private ManyToOneCombo<TemplateEntity> cbmDocumento;

	@AutoGenerated
	private ManyToOneCombo<ProdutoEntity> cmbProduto;
	...
	public ManyToOneCombo<ProdutoEntity> getCmbProduto() {
		return cmbProduto;
	}

	public void setCmbProduto(ManyToOneCombo<ProdutoEntity> cmbProduto) {
	...
	private GridLayout buildGridLayout_2() {
		...
		// txtDiaFaturamento
		txtDiaFaturamento = ComponentUtil
				.buildNumericField("Dia de Faturamento");
		...
		txtQuantidadeParcelas = ComponentUtil
				.buildNumericField("Quantidade de Parcelas");
		...
		txtIntervaloParcelas = ComponentUtil
				.buildNumericField("Intervalo entre Parcelas");
		...
		txtValorTarifa = ComponentUtil
				.buildCurrencyField("Valor tarifa de transportes");
	...
	private TabSheet buildTabSheet_2() {
		...
		tabSheet_2.addTab(buildHistoricoFaturaSubForm(),
				"Histórico Faturamento", null);

		tabSheet_2.addTab(buildHistoricoReajustesSubForm(),
				"Histórico de Reajustes", null);

		tabSheet_2.addTab(buildPrevisaoFaturamentoSubForm(),
	...
	private SubFormComponent<HistoricoReajusteEntity, Integer> buildHistoricoReajustesSubForm() {
		SubFormComponent<HistoricoReajusteEntity, Integer> subForm = new SubFormComponent<HistoricoReajusteEntity, Integer>(
				HistoricoReajusteEntity.class, new String[] { "indice",
						"valorAnterior", "valorAtual", "dataReajuste",
						"observacao" }, new String[] { "Índice",
			...
			protected HistoricoReajusteEntity getNovo() {
				HistoricoReajusteEntity contratoHistoricoReajuste = controller
	...
	private SubFormComponent<ContratoProduto, Integer> buildObjetoProdutoSubForm() {
		SubFormComponent<ContratoProduto, Integer> subForm = new SubFormComponent<ContratoProduto, Integer>(
				ContratoProduto.class, new String[] { "produto.nome" },
				new String[] { "Produto" }) {
			...
			protected ContratoProduto getNovo() {
				ContratoProduto contratoProduto = controller
						.novoContratoProduto();
	...
	private SubFormComponent<HistFaturamentoEntity, Integer> buildHistoricoFaturaSubForm() {
		SubFormComponent<HistFaturamentoEntity, Integer> subForm = new SubFormComponent<HistFaturamentoEntity, Integer>(
				HistFaturamentoEntity.class, new String[] { "dataFatura",
			...
			protected HistFaturamentoEntity getNovo() {
				HistFaturamentoEntity contratoHistFaturamento = controller
	...
	private Component buildPrevisaoFaturamentoSubForm() {
		...
		String[] atributos = new String[] { "pessoa", "numeroParcela",
				"dataPrevista", "valor" };

		String[] headers = new String[] { "Pessoa", "Número Parcela",
				"Data Prevista", "Valor" };

		this.previsaoFaturamentoSubForm = new SubFormComponent<PrevFaturamentoEntity, Integer>(
				PrevFaturamentoEntity.class, atributos, headers) {
				...
				return new TableFieldFactory() {
					...
					public Field<?> createField(Container container,
						...
						if ("dataPrevista".equals(propertyId)) {
							...
							TextField pessoaText = ComponentUtil
									.buildTextField(null);

							pessoaText
									.setConverter(new Converter<String, PessoaEntity>() {
								 ...
								 */
										...
										@Override
										public PessoaEntity convertToModel(
												String value,
												Class<? extends PessoaEntity> targetType,
												Locale locale)
			...
			protected PrevFaturamentoEntity getNovo() {
				PrevFaturamentoEntity contratoPrevFaturamento = controller
	...
	public void preencheContrato(ContratoEntity contrato) {
		...
		contrato.setTemplate((TemplateEntity) cbmDocumento.getValue());
		contrato.setContabilConta((ContabilContaEntity) cbmContabilConta.getValue());
		contrato.setContratoSolicitacaoServico((SolicitacaoServicoEntity) cmbSolicitacaoServico
				.getValue());
		...
		contrato.setDiaFaturamento(txtDiaFaturamento.getConvertedValue() != null ? (Integer) txtDiaFaturamento
				.getConvertedValue() : 0);
		// contrato.setPrimeiroVencimento(dtPrimeiroVencimento.getValue());
		contrato.setIntervaloEntreParcelas(txtIntervaloParcelas
				.getConvertedValue() != null ? (Integer) txtIntervaloParcelas
				.getConvertedValue() : 0);
	...
	public void preencheContratoForm(ContratoEntity contrato) {
		...
		cmbSolicitacaoServico
				.setValue(contrato.getContratoSolicitacaoServico());
		...
		txtIntervaloParcelas.setConvertedValue(contrato
		...
		txtQuantidadeParcelas.setValue(String.valueOf(contrato
		...
		historicoFaturamentoSubForm.fillWith(contrato
				.getContratosHistoricosFaturamentos());
		historicoReajustesSubForm.fillWith(contrato
				.getContratosHistoricosReajustes());
		previsaoFaturamentoSubForm.fillWith(contrato
	...
	public ManyToOneCombo<SolicitacaoServicoEntity> getCmbSolicitacaoServico() {
		return cmbSolicitacaoServico;
	}

	public void setCmbSolicitacaoServico(
			ManyToOneCombo<SolicitacaoServicoEntity> cmbSolicitacaoServico) {
		this.cmbSolicitacaoServico = cmbSolicitacaoServico;
	}

	public ManyToOneCombo<ContabilContaEntity> getCbmContabilConta() {
		return cbmContabilConta;
	}

	public void setCbmContabilConta(
			ManyToOneCombo<ContabilContaEntity> cbmContabilConta) {
		this.cbmContabilConta = cbmContabilConta;
	}

	public ManyToOneCombo<PessoaEntity> getCbmPessoa() {
		return cbmPessoa;
	}

	public void setCbmPessoa(ManyToOneCombo<PessoaEntity> cbmPessoa) {
		this.cbmPessoa = cbmPessoa;
	}

	public ManyToOneCombo<TipoContratoEntity> getCbmTipoContrato() {
		return cbmTipoContrato;
	}

	public void setCbmTipoContrato(ManyToOneCombo<TipoContratoEntity> cbmTipoContrato) {
		this.cbmTipoContrato = cbmTipoContrato;
	}

	public void setCbmDocumento(ManyToOneCombo<TemplateEntity> cbmDocumento) {
		this.cbmDocumento = cbmDocumento;
	}

	public ManyToOneCombo<TemplateEntity> getCbmDocumento() {
		return cbmDocumento;
	}
	...
	public void setPrevisaoFaturamentoSubForm(
			SubFormComponent<PrevFaturamentoEntity, Integer> previsaoFaturamentoSubForm) {
	...
	public void setHistoricoFaturamentoSubForm(
			SubFormComponent<HistFaturamentoEntity, Integer> historicoFaturamentoSubForm) {
	...
	public void setHistoricoReajustesSubForm(
			SubFormComponent<HistoricoReajusteEntity, Integer> historicoReajustesSubForm) {
