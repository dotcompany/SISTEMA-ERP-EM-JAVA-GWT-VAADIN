...
public class RequisicaoInternaFormView extends CustomComponent {
	...
	private TabSheet buildSubForms() {
		...
		requisicaoDetalheSubForm = new SubFormComponent<RequisicaoInternaDetalhe, Integer>(RequisicaoInternaDetalhe.class, new String[] { 
			"produto","quantidade"}, new String[] {"Produto","Quantidade" }) {
				...
				protected RequisicaoInternaDetalhe getNovo() {
					RequisicaoInternaDetalhe detalhe = controller.novoRequisicaoDetalhe();
					return detalhe;
				}
	...
	public void fillRequisicaoDetalhesSubForm(List<RequisicaoInternaDetalhe> requisicaoDetalhes) {
