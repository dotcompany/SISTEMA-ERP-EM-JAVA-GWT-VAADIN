...
public class ColaboradorOsFormView extends CustomComponent {
	...
	@AutoGenerated
	private TextField tfNome, tfFilial, tfApelido, tfCpfCnpj, tfRgInscEstadual,
			tfTelefone, tfCelular, tfCep, tfEndereco, tfCidade, tfBairro, tfUf,
			tfEmail, tfNrConta, tfSalarioFixo, tfComissaoServico,
			tfComissaoProduto;
	...
	@AutoGenerated
	private ManyToOneCombo<TipoColaboradorOs> cbTipoColaborador;
	...
	@AutoGenerated
	private ComboBox cbTipoSangue, cbPriorizarPgto, cbComissaoOver,
			cbPgtoComissao, cbLctoComissao;
	...
	private GridLayout buildFields() {
		...
		cbTipoColaborador = new ManyToOneCombo<TipoColaboradorOs>();
	...
	public ManyToOneCombo<TipoColaboradorOs> getCbTipoColaborador() {
		return cbTipoColaborador;
	}

	public void setCbTipoColaborador(
			ManyToOneCombo<TipoColaboradorOs> cbTipoColaborador) {
	...
	public enum TipoSangue {
		...
		A_POSITIVO("A+", "A+"), A_NEGATIVO("A-", "A-"), B_POSITIVO("B+", "B+"), B_NEGATIVO(
				"B-", "B-"), O_POSITIVO("O+", "O+"), O_NEGATIVO("O-", "O-"), AB_POSITIVO(
