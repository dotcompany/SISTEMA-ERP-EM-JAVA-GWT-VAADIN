...
public class TesteFormView extends CustomComponent {
	...
	public TesteFormView(final ApoliceSeguroFormController controller) {
	...
	public ComboBox getCbSeguradora() {
		return cbSeguradora;
	}

	public void setCbSeguradora(ComboBox cbSeguradora) {
	...
	public void carregarCmbSeguradora(List<SeguradoraEntity> lista) {
		BeanItemContainer<SeguradoraEntity> bic = new BeanItemContainer<SeguradoraEntity>(
				SeguradoraEntity.class, lista);
		this.cbSeguradora.setContainerDataSource(bic);
		this.cbSeguradora.setItemCaptionPropertyId("nome");
	}
