...
public class CarroFormView extends CustomComponent {
	...
	private GridLayout buildFields() {
		...
		tfRazao = new TextField();
		tfRazao.setCaption("Razão");
		tfRazao.setImmediate(false);
		tfRazao.setWidth("-1px");
...
//			@Override
//			public void valueChange(ValueChangeEvent event) {
//				System.out.println("Teste cliente value change carro");
//				System.out.println("Teste cliente value change carro cbMarca.getId()"+cbMarca.getId());
//				System.out.println("Teste cliente value change carro cbMarca.getValue().getId()"+cbMarca.getValue().getId());
//			}
//			
//		});
		...
		fields.addComponent(tfChassi,1,5);
