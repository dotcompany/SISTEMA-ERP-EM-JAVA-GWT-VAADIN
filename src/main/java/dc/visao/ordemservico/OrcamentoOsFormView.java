...
public class OrcamentoOsFormView extends CustomComponent {
	...
	private SubFormComponent<OrcamentoOsItemEntity, Integer> orcamentoOsItemSubForm;
...
//		fields.setHeight("100.0%");
	...
	private TabSheet buildSubFormOrcamentoOs() {
		...
		orcamentoOsItemSubForm = new SubFormComponent<OrcamentoOsItemEntity, Integer>(
				OrcamentoOsItemEntity.class, new String[] { "tipo", "descricao", "quantidade", "valorUnitario","valorSubTotal","taxaDesconto","valorDesconto","valorTotal"}, 
			...
			protected OrcamentoOsItemEntity getNovo() {
				OrcamentoOsItemEntity orcamentoOsItem = controller.novoOrcamentoOsItem();
				return orcamentoOsItem;
			}
			
	
			protected void getRemoverSelecionados(List<OrcamentoOsItemEntity> values) {
				controller.removerOrcamentoOsItem(values);
			}

			@Override
			public boolean validateItems(List<OrcamentoOsItemEntity> listItens) {
				for (OrcamentoOsItemEntity orcamentoOsItem : listItens) {
