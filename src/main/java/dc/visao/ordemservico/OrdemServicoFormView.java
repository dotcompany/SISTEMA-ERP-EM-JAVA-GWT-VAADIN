...
public class OrdemServicoFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<Colaborador> cbTecnico;

	@AutoGenerated
	private ManyToOneCombo<Colaborador> cbVendedor;
	
	@AutoGenerated
	private ManyToOneCombo<Produto> cbProduto;
	 ...
	 * editor.
	 */
	public OrdemServicoFormView(LancamentoPagarFormController controller) {
		buildMainLayout();
