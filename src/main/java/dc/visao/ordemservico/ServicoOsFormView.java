...
public class ServicoOsFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<GrupoOsEntity> cbGrupo;
	
	@AutoGenerated
	private ManyToOneCombo<SubGrupoOsEntity> cbSubGrupo;
...
//		horizontalLayout_7.addComponent(tfAtiva);
	...
	public ManyToOneCombo<GrupoOsEntity> getCbGrupo() {
		return cbGrupo;
	}

	public void setCbGrupo(ManyToOneCombo<GrupoOsEntity> cbGrupo) {
		this.cbGrupo = cbGrupo;
	}

	public ManyToOneCombo<SubGrupoOsEntity> getCbSubGrupo() {
		return cbSubGrupo;
	}

	public void setCbSubGrupo(ManyToOneCombo<SubGrupoOsEntity> cbSubGrupo) {
