...
public class TaxaDepreciacaoFormView extends CustomComponent {
	...
	private AbsoluteLayout buildAbsoluteLayout_1() {
		...
		tfNcm.setHeight("-1px");
		absoluteLayout_1.addComponent(tfNcm, "top:50.0px;left:22.0px;");
		...
		tfBem.setHeight("-1px");
		absoluteLayout_1.addComponent(tfBem, "top:50.0px;left:230.0px;");
		...
		absoluteLayout_1.addComponent(tfTaxa, "top:100.0px;left:230.0px;");
		...
		absoluteLayout_1.addComponent(tfVida, "top:100.0px;left:22.0px;");
