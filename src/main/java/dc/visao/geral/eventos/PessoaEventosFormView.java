...
public class PessoaEventosFormView extends CustomComponent {
	...
	private GridLayout bglCategoria() {
		...
		ckCliente.addValueChangeListener(event -> controller.vceVisibleTabSheet(event, 4));
	...
	private GridLayout bglGeralPessoaJuridica() {
		...
		tfInscricaoEstadual = ComponentUtil.buildTextField("Inscrição estadual");
		tfInscricaoMunicipal = ComponentUtil.buildTextField("Inscrição municipal");
		pdfDataConstituicao = ComponentUtil.buildPopupDateField("Data da constituição");
	...
	private SubFormComponent<PessoaContatoEntity, Integer> buildPessoaContatoSubForm() {
		...
		sfPessoaContato = new SubFormComponent<PessoaContatoEntity, Integer>(
			...
			protected PessoaContatoEntity getNovo() {
				PessoaContatoEntity pessoaContato = controller.adicionarPessoaContato();
	...
	public Panel getPlGeralPessoaFisica() {
		return plGeralPessoaFisica;
	}

	public void setPlGeralPessoaFisica(Panel plGeralPessoaFisica) {
		this.plGeralPessoaFisica = plGeralPessoaFisica;
	}

	public VerticalLayout getVlGeralPessoaFisica() {
		return vlGeralPessoaFisica;
	}

	public void setVlGeralPessoaFisica(VerticalLayout vlGeralPessoaFisica) {
		this.vlGeralPessoaFisica = vlGeralPessoaFisica;
	}

	public GridLayout getGlGeralPessoaFisica() {
		return glGeralPessoaFisica;
	}

	public void setGlGeralPessoaFisica(GridLayout glGeralPessoaFisica) {
		this.glGeralPessoaFisica = glGeralPessoaFisica;
	}

	public Panel getPlGeralPessoaJuridica() {
		return plGeralPessoaJuridica;
	}

	public void setPlGeralPessoaJuridica(Panel plGeralPessoaJuridica) {
		this.plGeralPessoaJuridica = plGeralPessoaJuridica;
	}

	public VerticalLayout getVlGeralPessoaJuridica() {
		return vlGeralPessoaJuridica;
	}

	public void setVlGeralPessoaJuridica(VerticalLayout vlGeralPessoaJuridica) {
		this.vlGeralPessoaJuridica = vlGeralPessoaJuridica;
	}

	public GridLayout getGlGeralPessoaJuridica() {
		return glGeralPessoaJuridica;
	}

	public void setGlGeralPessoaJuridica(GridLayout glGeralPessoaJuridica) {
		this.glGeralPessoaJuridica = glGeralPessoaJuridica;
	}

	public VerticalLayout getVlPessoaContato() {
		return vlPessoaContato;
	}

	public void setVlPessoaContato(VerticalLayout vlPessoaContato) {
		this.vlPessoaContato = vlPessoaContato;
	}

	public Panel getPlPessoaContato() {
		return plPessoaContato;
	}

	public void setPlPessoaContato(Panel plPessoaContato) {
		this.plPessoaContato = plPessoaContato;
	}

	public VerticalLayout getVlPessoaEndereco() {
		return vlPessoaEndereco;
	}

	public void setVlPessoaEndereco(VerticalLayout vlPessoaEndereco) {
		this.vlPessoaEndereco = vlPessoaEndereco;
	}

	public Panel getPlPessoaEndereco() {
		return plPessoaEndereco;
	}

	public void setPlPessoaEndereco(Panel plPessoaEndereco) {
		this.plPessoaEndereco = plPessoaEndereco;
	}

	public VerticalLayout getVlCliente() {
		return vlCliente;
	}

	public void setVlCliente(VerticalLayout vlCliente) {
		this.vlCliente = vlCliente;
	}

	public Panel getPlCliente() {
		return plCliente;
	}

	public void setPlCliente(Panel plCliente) {
		this.plCliente = plCliente;
	}

	public GridLayout getGlCliente() {
		return glCliente;
	}

	public void setGlCliente(GridLayout glCliente) {
		this.glCliente = glCliente;
	}
	...
	public PessoaEventosFormController getController() {
		return controller;
	}

	public void setController(PessoaEventosFormController controller) {
		this.controller = controller;
	}
	...
	public void setMocEstadoCivil(ManyToOneCombo<EstadoCivilEntity> mocEstadoCivil) {
