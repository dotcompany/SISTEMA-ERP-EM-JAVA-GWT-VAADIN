...
public class CerimonialEventosFormView extends CustomComponent {
	...
	@AutoGenerated
	private MaskedTextField tfCep, txtCnpj, tfTelefone, tfCelular, txtContato;
	...
	private GridLayout bglGeral() {
		...
		tfCep.setImmediate(true);
		tfCep.setWidth("200px");
		tfCep.setHeight("-1px");
...
//		cmbUf = ComponentUtil.buildComboBox("UF");
		...
		tfTelefone = ComponentUtil.buildMaskedTextField("Telefone comercial",	"(##) #####-####");
		tfTelefone.setMaskClientOnly(true);
		tfTelefone.setRequired(true);
		tfTelefone.setImmediate(true);
		tfTelefone.setWidth("200px");
		...
		tfCelular = ComponentUtil.buildMaskedTextField("Celular",	"(##) #####-####");
		tfCelular.setMaskClientOnly(true);
		tfCelular.setRequired(true);
		tfCelular.setImmediate(true);
		tfCelular.setWidth("200px");
		tfCelular.setHeight("-1px");
		...
		txtContato.setImmediate(true);
		txtContato.setWidth("200px");
	...
	public MaskedTextField getTxtContato() {
		return txtContato;
	}

	public void setTxtContato(MaskedTextField txtContato) {
	...
	public MaskedTextField getTfCelular() {
		return tfCelular;
	}

	public void setTfCelular(MaskedTextField tfCelular) {
