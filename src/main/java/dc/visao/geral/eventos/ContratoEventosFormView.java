...
import dc.entidade.geral.eventos.CerimonialEntity;
...
public class ContratoEventosFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<CerimonialEntity> mocNomeCerimonial;
	...
	private GridLayout bglGeral() {
		...
		glGeral.addComponent(txtAnoFormatura, 1, 0);
		
		
		cbTipoSemestre = ComponentUtil.buildComboBox("Semestre");
		glGeral.addComponent(cbTipoSemestre, 0, 2, 2, 2);
		...
		glGeral.addComponent(pdfDataContrato, 1, 1);
		...
		glGeral.addComponent(txtQuantidadeFormandos, 2, 0);
	...
	public ManyToOneCombo<CerimonialEntity> getMocNomeCerimonial() {
		return mocNomeCerimonial;
	}

	public void setMocNomeCerimonial(
			ManyToOneCombo<CerimonialEntity> mocNomeCerimonial) {
