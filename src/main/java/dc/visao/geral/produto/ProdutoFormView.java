...
public class ProdutoFormView extends CustomComponent {
	...
	@AutoGenerated
	private NumberField  tfEstoqueMaximo;

	@AutoGenerated
	private NumberField  tfEstoqueMinimo;

	@AutoGenerated
	private NumberField  tfEstoqueIdeal;

	@AutoGenerated
	private NumberField  tfQuantidadeEstoqueAnterior;

	@AutoGenerated
	private NumberField  tfQuantidadeEstoque;

	@AutoGenerated
	private NumberField  cfMarkup;

	@AutoGenerated
	private NumberField  cfPrecoLucroMaximo;

	@AutoGenerated
	private NumberField  cfPrecoLucroMinimo;

	@AutoGenerated
	private NumberField  cfPrecoLucroZero;

	@AutoGenerated
	private NumberField  cfCustoMedioLiquido;

	@AutoGenerated
	private NumberField  cfValorSugerido;

	@AutoGenerated
	private NumberField  cfValorVendaMinimo;

	@AutoGenerated
	private NumberField  cfValorVenda;

	@AutoGenerated
	private NumberField  cfValorCompra;
	...
	public NumberField  getTfEstoqueMaximo() {
		return tfEstoqueMaximo;
	}

	public void setTfEstoqueMaximo(NumberField  tfEstoqueMaximo) {
		this.tfEstoqueMaximo = tfEstoqueMaximo;
	}

	public NumberField  getTfEstoqueMinimo() {
		return tfEstoqueMinimo;
	}

	public void setTfEstoqueMinimo(NumberField  tfEstoqueMinimo) {
		this.tfEstoqueMinimo = tfEstoqueMinimo;
	}

	public NumberField  getTfEstoqueIdeal() {
		return tfEstoqueIdeal;
	}

	public void setTfEstoqueIdeal(NumberField  tfEstoqueIdeal) {
		this.tfEstoqueIdeal = tfEstoqueIdeal;
	}

	public NumberField  getTfQuantidadeEstoqueAnterior() {
		return tfQuantidadeEstoqueAnterior;
	}

	public void setTfQuantidadeEstoqueAnterior(NumberField  tfQuantidadeEstoqueAnterior) {
	...
	public NumberField  getCfMarkup() {
		return cfMarkup;
	}

	public void setCfMarkup(NumberField  cfMarkup) {
		this.cfMarkup = cfMarkup;
	}

	public NumberField  getCfPrecoLucroMaximo() {
		return cfPrecoLucroMaximo;
	}

	public void setCfPrecoLucroMaximo(NumberField  cfPrecoLucroMaximo) {
		this.cfPrecoLucroMaximo = cfPrecoLucroMaximo;
	}

	public NumberField  getCfPrecoLucroMinimo() {
		return cfPrecoLucroMinimo;
	}

	public void setCfPrecoLucroMinimo(NumberField  cfPrecoLucroMinimo) {
		this.cfPrecoLucroMinimo = cfPrecoLucroMinimo;
	}

	public NumberField  getCfPrecoLucroZero() {
		return cfPrecoLucroZero;
	}

	public void setCfPrecoLucroZero(NumberField  cfPrecoLucroZero) {
		this.cfPrecoLucroZero = cfPrecoLucroZero;
	}

	public NumberField  getCfCustoMedioLiquido() {
		return cfCustoMedioLiquido;
	}

	public void setCfCustoMedioLiquido(NumberField  cfCustoMedioLiquido) {
		this.cfCustoMedioLiquido = cfCustoMedioLiquido;
	}

	public NumberField  getCfValorSugerido() {
		return cfValorSugerido;
	}

	public void setCfValorSugerido(NumberField  cfValorSugerido) {
		this.cfValorSugerido = cfValorSugerido;
	}

	public NumberField  getCfValorVendaMinimo() {
		return cfValorVendaMinimo;
	}

	public void setTfValorVendaMinimo(NumberField  cfValorVendaMinimo) {
		this.cfValorVendaMinimo = cfValorVendaMinimo;
	}

	public NumberField  getCfValorVenda() {
		return cfValorVenda;
	}

	public void setCfValorVenda(NumberField  cfValorVenda) {
		this.cfValorVenda = cfValorVenda;
	}

	public NumberField  getCfValorCompra() {
		return cfValorCompra;
	}

	public void setCfValorCompra(NumberField  cfValorCompra) {
	...
	private GridLayout bglInformacaoValor() {
		...
		// tfValorCompra
		cfValorCompra = new NumberField ("Valor de compra");
		...
		// tfValorVendaMinimo
		// tfValorVendaMinimo = ComponentUtil.buildCurrencyField("Valor de venda mínimo");
		...
		// tfCustoMedioLiquido
		// tfCustoMedioLiquido = ComponentUtil.buildCurrencyField("Custo médio líquido");
		...
		// tfPrecoLucroZero
		// tfPrecoLucroZero = ComponentUtil.buildCurrencyField("Preço de lucro zero");
		...
		// tfPrecoLucroMinimo
		// tfPrecoLucroMinimo = ComponentUtil.buildCurrencyField("Preço de lucro mínimo");
		...
		// tfPrecoLucroMaximo
		// tfPrecoLucroMaximo = ComponentUtil.buildCurrencyField("Preço de lucro máximo");
		...
		//tfQuantidadeEstoqueAnterior = ComponentUtil.buildNumberField("Qtde de estoque anterior");
		tfQuantidadeEstoqueAnterior = new NumberField ("Qtde de estoque anterior");
