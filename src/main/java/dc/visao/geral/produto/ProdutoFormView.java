...
public class ProdutoFormView extends CustomComponent {
	...
	private GridLayout bglInformacaoValor() {
		...
		tfQuantidadeEstoqueAnterior = new TextField();
		tfQuantidadeEstoqueAnterior.setCaption("Qtde de estoque anterior");
		...
		tfEstoqueIdeal = new TextField();
		tfEstoqueIdeal.setCaption("Estoque ideal");
		...
		tfEstoqueMinimo = new TextField();
		tfEstoqueMinimo.setCaption("Estoque mínimo");
		...
		tfEstoqueMaximo = new TextField();
		tfEstoqueMaximo.setCaption("Estoque máximo");
