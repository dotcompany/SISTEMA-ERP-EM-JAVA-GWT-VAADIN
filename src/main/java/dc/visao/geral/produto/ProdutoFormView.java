...
public class ProdutoFormView extends CustomComponent {
	...
	@AutoGenerated
	private NumberField tfValorCompra;
	...
	public NumberField getTfValorCompra() {
		return tfValorCompra;
	}

	public void setTfValorCompra(NumberField tfValorCompra) {
	...
	private GridLayout bglInformacaoValor() {
		...
		// tfValorCompra
		tfValorCompra = new NumberField("Valor de compra");
