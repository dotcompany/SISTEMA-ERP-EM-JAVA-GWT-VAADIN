...
public class ProdutoFormView extends CustomComponent {
	...
	@AutoGenerated
	private NumericField tfQuantidadeEstoqueAnterior, tfQuantidadeEstoque;
	...
	private GridLayout bglInformacaoValor() {
		...
		tfQuantidadeEstoque = new NumericField("Quantidade de estoque");
		...
		tfQuantidadeEstoqueAnterior = new NumericField("Qtde de estoque anterior");
	...
	public NumericField getTfQuantidadeEstoqueAnterior() {
		return tfQuantidadeEstoqueAnterior;
	}

	public void setTfQuantidadeEstoqueAnterior(NumericField tfQuantidadeEstoqueAnterior) {
		this.tfQuantidadeEstoqueAnterior = tfQuantidadeEstoqueAnterior;
	}

	public NumericField getTfQuantidadeEstoque() {
