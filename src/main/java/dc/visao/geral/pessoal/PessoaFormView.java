...
public class PessoaFormView extends CustomComponent {
	...
	@AutoGenerated
	private TextField tfColaboradorPisNumeroPis;
	...
	private GridLayout bglColaboradorInformacaoGeral() {
		...
		// tfColaboradorPisNumeroPis
		tfColaboradorPisNumeroPis = new TextField();
		tfColaboradorPisNumeroPis.setCaption("Número do PIS");
		tfColaboradorPisNumeroPis.setNullRepresentation("");
		tfColaboradorPisNumeroPis.setImmediate(false);
		tfColaboradorPisNumeroPis.setWidth("91px");
		tfColaboradorPisNumeroPis.setHeight("-1px");
		hlRow7.addComponent(tfColaboradorPisNumeroPis);
