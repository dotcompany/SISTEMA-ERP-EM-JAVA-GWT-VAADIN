...
public class PessoaFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneComboField<PlanoConta> mocColaboradorPlanoConta;
	...
	public ManyToOneComboField<PlanoConta> getMocColaboradorPlanoConta() {
		return mocColaboradorPlanoConta;
	}

	public void setMocColaboradorPlanoConta(
			ManyToOneComboField<PlanoConta> mocColaboradorPlanoConta) {
	...
	private GridLayout bglColaboradorInformacaoComissao() {
		...
		mocColaboradorPlanoConta = new ManyToOneComboField<>(PlanoConta.class);
