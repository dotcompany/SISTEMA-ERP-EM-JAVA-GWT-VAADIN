...
public class PessoaFormView extends CustomComponent {
	...
	private GridLayout bglCliente() {
		...
		mocClienteSituacao.setWidth("394px");
		...
		mocClienteAtividade.setWidth("383px");
		mocClienteAtividade.setHeight("-1px");
		hlRow2.addComponent(mocClienteAtividade);
		...
		mocClienteContaContabil.setWidth("391px");
		mocClienteContaContabil.setHeight("-1px");
		hlRow2.addComponent(mocClienteContaContabil);
		...
		mocClienteOperacaoFiscal.setWidth("780px");
		mocClienteOperacaoFiscal.setHeight("-1px");
		hlRow3.addComponent(mocClienteOperacaoFiscal);
		...
		hlRow4.addComponent(pdfClienteDesde);
		...
		tfClienteContaTomador.setWidth("193px");
		tfClienteContaTomador.setHeight("-1px");
		hlRow4.addComponent(tfClienteContaTomador);
		...
		hlRow4.addComponent(cbClienteGerarFinanceiro);
		...
		hlRow4.addComponent(cbClienteIndicadorPreco);
		...
		hlRow4.addComponent(cbClienteTipoFrete);
		...
		hlRow5.addComponent(cbClienteFormaDesconto);
		...
		hlRow5.addComponent(tfClienteTaxaDesconto);
		...
		hlRow5.addComponent(tfClienteLimiteCredito);
		...
		hlRow6.addComponent(taClienteObservacao);
