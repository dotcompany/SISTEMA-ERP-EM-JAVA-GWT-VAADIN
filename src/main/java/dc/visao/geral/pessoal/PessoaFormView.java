...
public class PessoaFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneCombo<TipoColaboradorEntity> mocColaboradorTipoColaborador;

	@AutoGenerated
	private ManyToOneCombo<SituacaoColaboradorEntity> mocColaboradorSituacaoColaborador;

	@AutoGenerated
	private ManyToOneCombo<SindicatoEntity> mocColaboradorSindicato;

	@AutoGenerated
	private ManyToOneCombo<NivelFormacaoEntity> mocColaboradorNivelFormacao;

	@AutoGenerated
	private ManyToOneCombo<CargoEntity> mocColaboradorCargo;

	@AutoGenerated
	private ManyToOneCombo<ContabilContaEntity> mocColaboradorContaContabil;

	@AutoGenerated
	private ManyToOneCombo<SetorEntity> mocColaboradorSetor;
	...
	@AutoGenerated
	private ManyToOneCombo<UfEntity> mocColaboradorUf;
	...
	@AutoGenerated
	private ComboBox cbColaboradorPriorizarPgto;
	...
	@AutoGenerated
	private ManyToOneCombo<ContaCaixa> mocColaboradorContaCaixa;

	@AutoGenerated
	private ManyToOneCombo<PlanoConta> mocColaboradorPlanoConta;

	public ManyToOneCombo<TipoColaboradorEntity> getMocColaboradorTipoColaborador() {
		return mocColaboradorTipoColaborador;
	}

	public void setMocColaboradorTipoColaborador(
			ManyToOneCombo<TipoColaboradorEntity> mocColaboradorTipoColaborador) {
		this.mocColaboradorTipoColaborador = mocColaboradorTipoColaborador;
	}

	public ManyToOneCombo<SituacaoColaboradorEntity> getMocColaboradorSituacaoColaborador() {
		return mocColaboradorSituacaoColaborador;
	}

	public void setMocColaboradorSituacaoColaborador(
			ManyToOneCombo<SituacaoColaboradorEntity> mocColaboradorSituacaoColaborador) {
		this.mocColaboradorSituacaoColaborador = mocColaboradorSituacaoColaborador;
	}

	public ManyToOneCombo<SindicatoEntity> getMocColaboradorSindicato() {
		return mocColaboradorSindicato;
	}

	public void setMocColaboradorSindicato(
			ManyToOneCombo<SindicatoEntity> mocColaboradorSindicato) {
		this.mocColaboradorSindicato = mocColaboradorSindicato;
	}

	public ManyToOneCombo<NivelFormacaoEntity> getMocColaboradorNivelFormacao() {
		return mocColaboradorNivelFormacao;
	}

	public void setMocColaboradorNivelFormacao(
			ManyToOneCombo<NivelFormacaoEntity> mocColaboradorNivelFormacao) {
		this.mocColaboradorNivelFormacao = mocColaboradorNivelFormacao;
	}

	public ManyToOneCombo<CargoEntity> getMocColaboradorCargo() {
		return mocColaboradorCargo;
	}

	public void setMocColaboradorCargo(
			ManyToOneCombo<CargoEntity> mocColaboradorCargo) {
		this.mocColaboradorCargo = mocColaboradorCargo;
	}

	public ManyToOneCombo<ContabilContaEntity> getMocColaboradorContaContabil() {
		return mocColaboradorContaContabil;
	}

	public void setMocColaboradorContaContabil(
			ManyToOneCombo<ContabilContaEntity> mocColaboradorContaContabil) {
		this.mocColaboradorContaContabil = mocColaboradorContaContabil;
	}

	public ManyToOneCombo<SetorEntity> getMocColaboradorSetor() {
		return mocColaboradorSetor;
	}

	public void setMocColaboradorSetor(
			ManyToOneCombo<SetorEntity> mocColaboradorSetor) {
	...
	public ManyToOneCombo<UfEntity> getMocColaboradorUf() {
		return mocColaboradorUf;
	}

	public void setMocColaboradorUf(ManyToOneCombo<UfEntity> mocColaboradorUf) {
		this.mocColaboradorUf = mocColaboradorUf;
	}
	...
	public ComboBox getCbColaboradorPriorizarPgto() {
		return cbColaboradorPriorizarPgto;
	}

	public void setCbColaboradorPriorizarPgto(
			ComboBox cbColaboradorPriorizarPgto) {
		this.cbColaboradorPriorizarPgto = cbColaboradorPriorizarPgto;
	}
	...
	public ManyToOneCombo<ContaCaixa> getMocColaboradorContaCaixa() {
		return mocColaboradorContaCaixa;
	}

	public void setMocColaboradorContaCaixa(
			ManyToOneCombo<ContaCaixa> mocColaboradorContaCaixa) {
		this.mocColaboradorContaCaixa = mocColaboradorContaCaixa;
	}

	public ManyToOneCombo<PlanoConta> getMocColaboradorPlanoConta() {
		return mocColaboradorPlanoConta;
	}

	public void setMocColaboradorPlanoConta(
			ManyToOneCombo<PlanoConta> mocColaboradorPlanoConta) {
	...
	private GridLayout bglColaboradorInformacaoGeral() {
		...
		mocColaboradorTipoColaborador = new ManyToOneCombo<>();
		...
		mocColaboradorSituacaoColaborador = new ManyToOneCombo<>();
		...
		mocColaboradorSindicato = new ManyToOneCombo<>();
		...
		// mocColaboradorUf
		mocColaboradorUf = new ManyToOneCombo<>();
		mocColaboradorUf.setCaption("UF");
		mocColaboradorUf.setImmediate(false);
		mocColaboradorUf.setWidth("60px");
		mocColaboradorUf.setHeight("-1px");
		hlRow7.addComponent(mocColaboradorUf);
	...
	private GridLayout bglColaboradorInformacaoComissao() {
		...
		tfColaboradorSalarioFixo = new TextField();
		tfColaboradorSalarioFixo.setCaption("Salário fixo");
