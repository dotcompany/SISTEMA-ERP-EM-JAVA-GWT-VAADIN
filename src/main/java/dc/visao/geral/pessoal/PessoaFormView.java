...
public class PessoaFormView extends CustomComponent {
	...
	private GridLayout buildContentCnh() {
		...
		cmbCategoriaCnh = ComponentUtil.buildComboBox("Categoria da CNH");
	...
	private GridLayout buildFields() {
		...
		cmbTipoPessoa = new ComboBox("Tipo de pessoa");
		...
		// ogCategoriaPessoa.addItem("Cliente");
		// ogCategoriaPessoa.addItem("Fornecedor");
		// ogCategoriaPessoa.addItem("Colaborador");
		// ogCategoriaPessoa.addItem("Transportadora");
	...
	private SubFormComponent<PessoaEnderecoEntity, Integer> buildPessoaEnderecoSubForm() {
		...
		String[] atributos = new String[] { "cep", "logradouro", "numero",
				"complemento", "bairro", "cidade", "municipioIbge", "uf",
				"fone", "fax", "principal", "entrega", "cobranca",
				"correspondencia" };

		String[] headers = new String[] { "CEP", "Logradouro", "Nº",
				"Complemento", "Bairro", "Cidade", "Município IBGE", "UF",
