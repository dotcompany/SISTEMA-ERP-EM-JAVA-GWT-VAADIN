...
public class ColaboradorFormView extends CustomComponent {
	...
	@AutoGenerated
	private ManyToOneComboField<PlanoConta> mocPlanoConta;
	...
	public ManyToOneComboField<PlanoConta> getMocPlanoConta() {
		return mocPlanoConta;
	}

	public void setMocPlanoConta(ManyToOneComboField<PlanoConta> mocPlanoConta) {
	...
	public void buildAbaComissao() {
		...
		mocPlanoConta = new ManyToOneComboField<>(PlanoConta.class);
